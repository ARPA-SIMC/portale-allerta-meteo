...
public class VerificaDatoServiceUtil {
	...
	private static ServiceTracker<VerificaDatoService, VerificaDatoService>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(VerificaDatoService.class);

		ServiceTracker<VerificaDatoService, VerificaDatoService>
			serviceTracker =
				new ServiceTracker<VerificaDatoService, VerificaDatoService>(
					bundle.getBundleContext(), VerificaDatoService.class, null);
