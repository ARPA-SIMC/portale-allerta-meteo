...
public interface VerificaLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link VerificaLocalServiceUtil} to access the verifica local service. Add custom service methods to <code>allerta.verifica.service.impl.VerificaLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
