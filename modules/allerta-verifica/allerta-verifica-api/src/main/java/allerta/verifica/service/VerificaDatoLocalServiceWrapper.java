...
public class VerificaDatoLocalServiceWrapper
	implements ServiceWrapper<VerificaDatoLocalService>,
	...
	public com.liferay.portal.kernel.model.PersistedModel createPersistedModel(
		...
		return _verificaDatoLocalService.createPersistedModel(primaryKeyObj);
	}
	...
	public <T> T dslQuery(com.liferay.petra.sql.dsl.query.DSLQuery dslQuery) {
		return _verificaDatoLocalService.dslQuery(dslQuery);
	}
	...
	public int dslQueryCount(
		...
		return _verificaDatoLocalService.dslQueryCount(dslQuery);
	}
	...
	public BasePersistence<?> getBasePersistence() {
		return _verificaDatoLocalService.getBasePersistence();
	}
