...
public interface VerificaDatoLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link VerificaDatoLocalServiceUtil} to access the verifica dato local service. Add custom service methods to <code>allerta.verifica.service.impl.VerificaDatoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
