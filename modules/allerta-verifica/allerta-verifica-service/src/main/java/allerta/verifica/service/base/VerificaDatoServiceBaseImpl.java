...
import allerta.verifica.service.VerificaDatoService;
...
/**
 * Provides the base implementation for the verifica dato remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link allerta.verifica.service.impl.VerificaDatoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see allerta.verifica.service.impl.VerificaDatoServiceImpl
 * @generated
 */
public abstract class VerificaDatoServiceBaseImpl
	extends BaseServiceImpl
	implements VerificaDatoService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>VerificaDatoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>allerta.verifica.service.VerificaDatoServiceUtil</code>.
	 */
	...
	/**
	 * Returns the utente lavoro remote service.
	 *
	 * @return the utente lavoro remote service
	 */
	public allerta.verifica.service.UtenteLavoroService
		getUtenteLavoroService() {

		return utenteLavoroService;
	}

	/**
	 * Sets the utente lavoro remote service.
	 *
	 * @param utenteLavoroService the utente lavoro remote service
	 */
	public void setUtenteLavoroService(
		allerta.verifica.service.UtenteLavoroService utenteLavoroService) {

		this.utenteLavoroService = utenteLavoroService;
	}
	...
	/**
	 * Returns the verifica remote service.
	 *
	 * @return the verifica remote service
	 */
	public allerta.verifica.service.VerificaService getVerificaService() {
		return verificaService;
	}

	/**
	 * Sets the verifica remote service.
	 *
	 * @param verificaService the verifica remote service
	 */
	public void setVerificaService(
		allerta.verifica.service.VerificaService verificaService) {
	...
	/**
	 * Returns the verifica dato remote service.
	 *
	 * @return the verifica dato remote service
	 */
	public VerificaDatoService getVerificaDatoService() {
		return verificaDatoService;
	}

	/**
	 * Sets the verifica dato remote service.
	 *
	 * @param verificaDatoService the verifica dato remote service
	 */
	public void setVerificaDatoService(
		VerificaDatoService verificaDatoService) {

		this.verificaDatoService = verificaDatoService;
	}
	...
	public String getOSGiServiceIdentifier() {
		return VerificaDatoService.class.getName();
	}
	...
	@BeanReference(type = allerta.verifica.service.UtenteLavoroService.class)
	protected allerta.verifica.service.UtenteLavoroService utenteLavoroService;
	...
	@BeanReference(type = allerta.verifica.service.VerificaService.class)
	protected allerta.verifica.service.VerificaService verificaService;
	...
	@BeanReference(type = VerificaDatoService.class)
	protected VerificaDatoService verificaDatoService;
