...
/**
 * Provides the local service interface for elevazione. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author UTENTE
 * @see elevazioneLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface elevazioneLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>it.eng.animazione.image.service.impl.elevazioneLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the elevazione local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link elevazioneLocalServiceUtil} if injection and service tracking are not available.
	 */
