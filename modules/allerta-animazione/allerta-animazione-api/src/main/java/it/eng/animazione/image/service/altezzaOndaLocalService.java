...
public interface altezzaOndaLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link altezzaOndaLocalServiceUtil} to access the altezza onda local service. Add custom service methods to <code>it.eng.animazione.image.service.impl.altezzaOndaLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
