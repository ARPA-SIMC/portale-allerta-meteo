...
public class altezzaOndaLocalServiceUtil {
	 ...
	 */
	public static altezzaOnda addaltezzaOnda(altezzaOnda altezzaOnda) {
	 ...
	 */
	public static altezzaOnda createaltezzaOnda(long id) {
	 ...
	 */
	public static altezzaOnda deletealtezzaOnda(altezzaOnda altezzaOnda) {
	 ...
	 */
	public static altezzaOnda deletealtezzaOnda(long id)
		throws PortalException {
	...
	public static altezzaOnda fetchaltezzaOnda(long id) {
	 ...
	 * @throws PortalException if a altezza onda with the primary key could not be found
	 */
	public static altezzaOnda getaltezzaOnda(long id) throws PortalException {
	 ...
	 */
	public static List<altezzaOnda> getaltezzaOndas(int start, int end) {
	 ...
	 */
	public static altezzaOnda updatealtezzaOnda(altezzaOnda altezzaOnda) {
	...
	private static final Snapshot<altezzaOndaLocalService> _serviceSnapshot =
		new Snapshot<>(
			altezzaOndaLocalServiceUtil.class, altezzaOndaLocalService.class);
