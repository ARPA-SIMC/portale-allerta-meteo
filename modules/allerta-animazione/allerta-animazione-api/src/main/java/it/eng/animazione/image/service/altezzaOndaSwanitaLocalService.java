...
public interface altezzaOndaSwanitaLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>it.eng.animazione.image.service.impl.altezzaOndaSwanitaLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the altezza onda swanita local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link altezzaOndaSwanitaLocalServiceUtil} if injection and service tracking are not available.
	 */
