...
public interface altezzaOndaAdriacLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link altezzaOndaAdriacLocalServiceUtil} to access the altezza onda adriac local service. Add custom service methods to <code>it.eng.animazione.image.service.impl.altezzaOndaAdriacLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
