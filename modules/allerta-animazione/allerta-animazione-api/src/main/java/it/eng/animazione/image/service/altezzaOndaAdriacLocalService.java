...
/**
 * Provides the local service interface for altezzaOndaAdriac. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author UTENTE
 * @see altezzaOndaAdriacLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface altezzaOndaAdriacLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>it.eng.animazione.image.service.impl.altezzaOndaAdriacLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the altezza onda adriac local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link altezzaOndaAdriacLocalServiceUtil} if injection and service tracking are not available.
	 */
