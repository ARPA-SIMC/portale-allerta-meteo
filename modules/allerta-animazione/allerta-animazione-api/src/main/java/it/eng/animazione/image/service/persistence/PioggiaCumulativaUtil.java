...
public class PioggiaCumulativaUtil {
	...
	public static List<PioggiaCumulativa> findByCumulazione(
		...
		return getPersistence().findByCumulazione(
			cumulazione, start, end, orderByComparator, useFinderCache);
	}
	...
	public static void setPersistence(
		PioggiaCumulativaPersistence persistence) {

		_persistence = persistence;
	}

	private static volatile PioggiaCumulativaPersistence _persistence;
