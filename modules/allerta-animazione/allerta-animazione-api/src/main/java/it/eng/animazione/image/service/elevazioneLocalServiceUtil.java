...
public class elevazioneLocalServiceUtil {
	 ...
	 */
	public static elevazione addelevazione(elevazione elevazione) {
	 ...
	 */
	public static elevazione createelevazione(long id) {
	 ...
	 */
	public static elevazione deleteelevazione(elevazione elevazione) {
	 ...
	 */
	public static elevazione deleteelevazione(long id) throws PortalException {
	...
	public static elevazione fetchelevazione(long id) {
	 ...
	 * @throws PortalException if a elevazione with the primary key could not be found
	 */
	public static elevazione getelevazione(long id) throws PortalException {
	 ...
	 */
	public static List<elevazione> getelevaziones(int start, int end) {
	 ...
	 */
	public static elevazione updateelevazione(elevazione elevazione) {
	...
	private static final Snapshot<elevazioneLocalService> _serviceSnapshot =
		new Snapshot<>(
			elevazioneLocalServiceUtil.class, elevazioneLocalService.class);
