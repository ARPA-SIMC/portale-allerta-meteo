  ...
  <footer class="col-12 flex-column flex-md-row align-content-center footer">
    <div class="container">
        <div class="row d-print-flex">
            <div class="col-12">
                <h2><#if w3c_language_id == 'en-GB'>Allerta Meteo Emilia-Romagna is a project by<#else>Allerta Meteo Emilia-Romagna &egrave; un progetto di</#if></h2>
            </div>
            
            <div class="col-12 col-lg-4 mb-4">
                <a class="footer__brand" href="https://www.arpae.it/" title="<#if w3c_language_id == 'en-GB'>Go to the Arpae website<#else>Vai al sito di Arpae</#if>">
                    <picture>
            ...
            <div class="col-12 col-lg-4 mb-4">
                <a class="footer__brand" 
                    ...
                    title="<#if w3c_language_id == 'en-GB'>Go to the website of Agenzia per la sicurezza territoriale e la protezione civile dell'Emilia-Romagna<#else>Vai al sito di Agenzia per la sicurezza territoriale e la protezione civile dell'Emilia-Romagna</#if>">
                    <picture>
                        <img src="${css_folder}/../img/logo-protezione-civile--neg.png" alt="<#if w3c_language_id == 'en-GB'>Logo of Agenzia per la sicurezza territoriale e la protezione civile<#else>Logo di Agenzia per la sicurezza territoriale e la protezione civile</#if>" class="brand--prociv">
                    </picture>
                </a>    
            ...
            <div class="col-12 mt-3 d-flex flex-column flex-md-row justify-content-md-center align-items-md-center">
                ...
                <nav  role="navigation">
                    <ul class="nav flex-column flex-md-row">
                            <li class="nav-item ">
                                <a class="nav-link" href="/informativa" title="<#if w3c_language_id == 'en-GB'>Go to Privacy information<#else>Vai a Informativa sulla privacy</#if>"><#if w3c_language_id == 'en-GB'>Privacy information<#else>Informativa sulla privacy</#if></a>
                            </li>
                            <li class="nav-item ">
                                <a class="nav-link" href="/cookie" title="<#if w3c_language_id == 'en-GB'>Go to Cookie information<#else>Vai a Informativa sui cookie</#if>"><#if w3c_language_id == 'en-GB'>Cookie information<#else>Informativa sui cookie</#if></a>
                            </li>
                            <li class="nav-item ">
                                <a class="nav-link" href="/note-legali" title="<#if w3c_language_id == 'en-GB'>Go to Legal notes<#else>Vai a Note legali</#if>"><#if w3c_language_id == 'en-GB'>Legal notes<#else>Note legali</#if></a>
                            </li>				
			    <li class="nav-item"><span  class="nav-link" style="padding-left:5px;padding-right:10px;color:#ffffff"><#if w3c_language_id == 'en-GB'>Follow us on<#else>Seguici su</#if></span>
	    			<span>
                <a style="text-decoration:none" target="_blank" title="<#if w3c_language_id == 'en-GB'>Follow Allerta Meteo Emilia-Romagna on X<#else>Segui Allerta Meteo Emilia-Romagna su X</#if>" href="https://x.com/AllertaMeteoRER"><img src="/o/allerta-theme/img/social/x.svg" style="font-size:1.0rem;margin-right:0.5rem;height:1.0rem;background-color:#B7E6FF;margin-bottom: 5px;"></a>
            			</span>
            			<span>
                <a style="text-decoration:none" target="_blank" title="<#if w3c_language_id == 'en-GB'>Follow Allerta Meteo Emilia-Romagna on Telegram<#else>Segui Allerta Meteo Emilia-Romagna su Telegram</#if>" href="https://t.me/AllertaMeteoEMR"><span class="icon i-telegram" style="margin-right:0.5rem"/></a>
           			 </span>
            			<span>
                <a style="text-decoration:none" target="_blank" title="<#if w3c_language_id == 'en-GB'>Follow Allerta Meteo Emilia-Romagna on WhatsApp<#else>Segui Allerta Meteo Emilia-Romagna su WhatsApp</#if>" href="https://whatsapp.com/channel/0029Vb7unKRLSmbS47kGVv3c"><span class="icon i-whatsapp" style="font-size:1.2rem"/></a>
           			 </span>
			    </li>
                    </ul>
                </nav>
