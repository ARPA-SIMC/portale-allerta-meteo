...
/**
 * Provides the local service interface for HRW. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see HRWLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface HRWLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>allerta.dewetra.service.impl.HRWLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the hrw local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link HRWLocalServiceUtil} if injection and service tracking are not available.
	 */
