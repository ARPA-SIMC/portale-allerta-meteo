...
public interface HRWLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link HRWLocalServiceUtil} to access the hrw local service. Add custom service methods to <code>allerta.dewetra.service.impl.HRWLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
