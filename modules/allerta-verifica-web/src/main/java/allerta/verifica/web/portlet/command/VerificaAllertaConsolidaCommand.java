...
@Component(
		...
		property = {
				...
				"mvc.command.name=/allertaer/verifica/consolida"
		},
		service = MVCActionCommand.class
		)
public class VerificaAllertaConsolidaCommand extends BaseMVCActionCommand{
	...
	protected void doProcessAction(ActionRequest actionRequest, ActionResponse actionResponse) throws Exception {
		...
		try {
			...
			if (v!=null) {
				...
				VerificaAllertaBean.tuttoVerde(allertaId);
			}
