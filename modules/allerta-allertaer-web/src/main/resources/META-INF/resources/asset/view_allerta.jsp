...
for (AllertaStato b : bb) {
	if (b.getStatoId()!=1000 && b.getStatoId()!=0) {
		...
		if (!trovato) {
			...
			if (b.getEventoId()==1) classi.add(".idraulica");
			if (b.getEventoId()==2) classi.add(".idrogeologica");
			if (b.getEventoId()==3) classi.add(".temporali");
			if (b.getEventoId()==4) classi.add(".vento");
			if (b.getEventoId()==5) classi.add(".temperature");
			if (b.getEventoId()==6) classi.add(".neve");
			if (b.getEventoId()==7) classi.add(".ghiaccio");
			if (b.getEventoId()==8) classi.add(".mare");
			if (b.getEventoId()==9) classi.add(".costiera");
		}
