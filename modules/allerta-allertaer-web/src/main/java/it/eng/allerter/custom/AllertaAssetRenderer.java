 ...
 */
public class AllertaAssetRenderer extends BaseJSPAssetRenderer<Allerta>{

	 private Allerta _feedback;
     
	 public AllertaAssetRenderer(Allerta feedback) {
	        _feedback = feedback;
	 }
	 
	@Override
	public Allerta getAssetObject() {
	...
	public long getClassPK() {
		// TODO Auto-generated method stub
		return _feedback.getAllertaId();
	}

	@Override
	public String getSummary(PortletRequest portletRequest, PortletResponse portletResponse) {
		// TODO Auto-generated method stub
		return "Sommario "+_feedback.getDescrizioneMeteo();
	}
