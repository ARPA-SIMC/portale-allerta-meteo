...
public abstract class FonteServiceBaseImpl
	...
	implements AopService, FonteService, IdentifiableOSGiService {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			FonteService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		fonteService = (FonteService)aopProxy;
	}
