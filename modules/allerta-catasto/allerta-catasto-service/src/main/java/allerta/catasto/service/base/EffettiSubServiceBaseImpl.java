...
public abstract class EffettiSubServiceBaseImpl
	...
	implements AopService, EffettiSubService, IdentifiableOSGiService {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EffettiSubService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		effettiSubService = (EffettiSubService)aopProxy;
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		EffettiSubServiceBaseImpl.class);
