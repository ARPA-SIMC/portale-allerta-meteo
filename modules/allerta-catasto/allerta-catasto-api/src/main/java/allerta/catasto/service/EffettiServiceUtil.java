...
public class EffettiServiceUtil {
	...
	private static ServiceTracker<EffettiService, EffettiService>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(EffettiService.class);

		ServiceTracker<EffettiService, EffettiService> serviceTracker =
			new ServiceTracker<EffettiService, EffettiService>(
				bundle.getBundleContext(), EffettiService.class, null);
