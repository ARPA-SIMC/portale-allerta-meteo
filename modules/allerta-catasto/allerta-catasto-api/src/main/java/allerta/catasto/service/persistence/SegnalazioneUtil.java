...
public class SegnalazioneUtil {
	...
	public static List<Segnalazione> findByDocumentoAssociato(
		...
		return getPersistence().findByDocumentoAssociato(
			documentoAssociato, start, end, orderByComparator, useFinderCache);
	}
	...
	public static void setPersistence(SegnalazionePersistence persistence) {
		_persistence = persistence;
	}

	private static volatile SegnalazionePersistence _persistence;
