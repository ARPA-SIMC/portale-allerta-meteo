...
public class EffettiSubUtil {
	 ...
	 */
	public static EffettiSub create(EffettiSubPK effettiSubPK) {
	 ...
	 */
	public static EffettiSub remove(EffettiSubPK effettiSubPK)
	 ...
	 * @throws NoSuchEffettiSubException if a effetti sub with the primary key could not be found
	 */
	public static EffettiSub findByPrimaryKey(EffettiSubPK effettiSubPK)
		throws allerta.catasto.exception.NoSuchEffettiSubException {
	 ...
	 */
	public static EffettiSub fetchByPrimaryKey(EffettiSubPK effettiSubPK) {
	...
	public static void setPersistence(EffettiSubPersistence persistence) {
		_persistence = persistence;
	}

	private static volatile EffettiSubPersistence _persistence;
