...
public interface CategoriaLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CategoriaLocalServiceUtil} to access the categoria local service. Add custom service methods to <code>allerta.catasto.service.impl.CategoriaLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
