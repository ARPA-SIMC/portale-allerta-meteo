...
public class FonteLocalServiceUtil {
	 ...
	 */
	public static Fonte addFonte(Fonte fonte) {
	 ...
	 */
	public static Fonte createFonte(long id) {
	 ...
	 */
	public static Fonte deleteFonte(Fonte fonte) {
	 ...
	 */
	public static Fonte deleteFonte(long id) throws PortalException {
	...
	public static Fonte fetchFonte(long id) {
	 ...
	 * @throws PortalException if a fonte with the primary key could not be found
	 */
	public static Fonte getFonte(long id) throws PortalException {
	 ...
	 */
	public static List<Fonte> getFontes(int start, int end) {
	 ...
	 */
	public static Fonte updateFonte(Fonte fonte) {
	...
	private static final Snapshot<FonteLocalService> _serviceSnapshot =
		new Snapshot<>(FonteLocalServiceUtil.class, FonteLocalService.class);
