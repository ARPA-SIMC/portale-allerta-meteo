...
public class FonteServiceUtil {
	...
	private static ServiceTracker<FonteService, FonteService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(FonteService.class);

		ServiceTracker<FonteService, FonteService> serviceTracker =
			new ServiceTracker<FonteService, FonteService>(
				bundle.getBundleContext(), FonteService.class, null);
