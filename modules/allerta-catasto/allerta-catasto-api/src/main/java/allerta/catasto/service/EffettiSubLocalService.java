...
public interface EffettiSubLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link EffettiSubLocalServiceUtil} to access the effetti sub local service. Add custom service methods to <code>allerta.catasto.service.impl.EffettiSubLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
