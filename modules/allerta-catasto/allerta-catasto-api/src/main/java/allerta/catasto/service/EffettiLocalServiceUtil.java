...
public class EffettiLocalServiceUtil {
	 ...
	 */
	public static Effetti addEffetti(Effetti effetti) {
	 ...
	 */
	public static Effetti createEffetti(long id) {
	 ...
	 */
	public static Effetti deleteEffetti(Effetti effetti) {
	 ...
	 */
	public static Effetti deleteEffetti(long id) throws PortalException {
	...
	public static Effetti fetchEffetti(long id) {
	 ...
	 * @throws PortalException if a effetti with the primary key could not be found
	 */
	public static Effetti getEffetti(long id) throws PortalException {
	 ...
	 */
	public static List<Effetti> getEffettis(int start, int end) {
	 ...
	 */
	public static Effetti updateEffetti(Effetti effetti) {
	...
	private static final Snapshot<EffettiLocalService> _serviceSnapshot =
		new Snapshot<>(
			EffettiLocalServiceUtil.class, EffettiLocalService.class);
