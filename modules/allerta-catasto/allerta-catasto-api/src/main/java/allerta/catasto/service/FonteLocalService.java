...
/**
 * Provides the local service interface for Fonte. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see FonteLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface FonteLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>allerta.catasto.service.impl.FonteLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the fonte local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link FonteLocalServiceUtil} if injection and service tracking are not available.
	 */
