...
public interface FonteLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link FonteLocalServiceUtil} to access the fonte local service. Add custom service methods to <code>allerta.catasto.service.impl.FonteLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
