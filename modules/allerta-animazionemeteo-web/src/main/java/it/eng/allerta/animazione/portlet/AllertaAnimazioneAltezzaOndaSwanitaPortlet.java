...
@Component(
	...
	property = {
			...
			"javax.portlet.display-name=Animazione Swanita", 
			"javax.portlet.init-param.template-path=/",
			"javax.portlet.init-param.view-template=/animareswanita.jsp",
			"javax.portlet.name=" + "AllertaAnimazioneAltezzaOndaSwanitaPortlet",
			"javax.portlet.resource-bundle=content.Language",
			"javax.portlet.security-role-ref=power-user,user"
	},
	service = Portlet.class
)
public class AllertaAnimazioneAltezzaOndaSwanitaPortlet extends MVCPortlet {
