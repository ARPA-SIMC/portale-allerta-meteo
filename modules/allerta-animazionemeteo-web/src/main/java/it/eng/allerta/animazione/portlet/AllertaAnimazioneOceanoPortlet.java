...
@Component(
	...
	property = {
			...
			"javax.portlet.display-name=Animazione Elevazione Oceano", 
			"javax.portlet.init-param.template-path=/",
			"javax.portlet.init-param.view-template=/anioceano.jsp",
			"javax.portlet.name=" + AllertaKeys.AllertaAnimazioneOceanoPortlet,
			"javax.portlet.resource-bundle=content.Language",
			"javax.portlet.security-role-ref=power-user,user"
	},
	service = Portlet.class
)
public class AllertaAnimazioneOceanoPortlet extends MVCPortlet {
