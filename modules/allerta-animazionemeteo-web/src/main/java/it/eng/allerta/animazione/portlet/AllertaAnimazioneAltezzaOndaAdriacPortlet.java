...
@Component(
	...
	property = {
			...
			"javax.portlet.display-name=Animazione Adriac", 
			"javax.portlet.init-param.template-path=/",
			"javax.portlet.init-param.view-template=/animareadriac.jsp",
			"javax.portlet.name=" + "AllertaAnimazioneAltezzaOndaAdriacPortlet",
			"javax.portlet.resource-bundle=content.Language",
			"javax.portlet.security-role-ref=power-user,user"
	},
	service = Portlet.class
)
public class AllertaAnimazioneAltezzaOndaAdriacPortlet extends MVCPortlet {
