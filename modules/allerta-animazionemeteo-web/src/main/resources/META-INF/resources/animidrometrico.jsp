...
<section id="map-section--dato-osservato--radar"
	...
	<div class="map-section__body">
		<div
			class="map-component map-component--data map-component--dato-osservato--idrometrico"
			id="map-component--dato-osservato--temperatura"
			data-toggle="data-map" data-scenarios="idrometrico">
						...
						<div class="map-toolbar__datetime">
							...
							<div class="form-group">
								...
								<div class="input-group date"
									...
									<input type="text"
										id="datetimepicker--dato-osservato--idrometrico__field"
										class="form-control datetimepicker-input" /> <a
										class="input-group-append datepickerbutton"
										href="#datetimepicker--dato-osservato--idrometrico">
