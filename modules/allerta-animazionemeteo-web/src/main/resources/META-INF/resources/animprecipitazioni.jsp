					...
					<div class="col-12 col-md-6">
						...
						<div class="map-toolbar__datetime">
							...
							<div class="form-group">
								...
								<label for="datetimepicker--dato-osservato--precipitazioni__field">Giorno
		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				...
				<div class="modal-lead">
					I livelli di criticit&agrave; di ogni fenomeno si basano su soglie e
					...
					<div class="row flex-lg-column">
						...
						<div class="col-12 col-lg-5 mb-4">
							...
							<ul class="mb-md-2 nav map-legend__utility-guides flex-column">
								<li class="nav-item"><a class="nav-link" href="<%=doc.linkLetturaPrecipitazioni() %>"
