	...
	<div class="container d-flex">
		...
		<div class="row w-100 justify-content-between">
			<div class="col-10 col-lg-10">
				<h1>Pioggia cumulata 24h</h1>
				<p class="lead">Precipitazione cumulata nelle 24 ore precedenti
			...
			<div class="d-flex page-tools" role="group"
				...
				<div class="page-tools__share-popover-content">
					<div
						...
						data-url="http://www.allerta.nuovoportale.it/styleguide/prototype/pages/single-dato.php?c=cumulata-24h"
...
<section id="map-section--dato-osservato--cumulata-24h"	class="container map-section map-section--full-width">


	<div class="map-section__body">

		<div
			class="map-component map-component--data map-component--dato-osservato--cumulata-24h"
			id="map-component--dato-osservato--cumulata-24h"
			data-toggle="data-map" data-scenarios="cumulata-24h">
				...
				<div class="row flex-column-reverse flex-md-row map-toolbar">
					<div class="col-12 col-md-6">
						<div class="map-toolbar__animation">
							<div class="form-group map-animation-dropdown">
								<label for="animation__timespan--dato-osservato--cumulata-24h">
									Animazione </label>
								<div class="input-group">
									<select id="animation__timespan--dato-osservato--cumulata-24h"
											class="form-control map-animation__timespan">
									</select>
									<div class="input-group-append">
										<a
											href="#map-toolbar__time-player--dato-osservato--cumulata-24h"
											title="Lancia/Ferma l'animazione"
											data-source="#animation__timespan--dato-osservato--cumulata-24h"
					...
					<div class="col-12 col-md-6">
						<div class="map-toolbar__timewheel-player"
							id="#map-toolbar__timewheel-player--dato-osservato--cumulata-24h">
			...
			<div
				...
				id="map--dato-osservato--cumulata-24h" tabindex="0"
				style="display: none;">
