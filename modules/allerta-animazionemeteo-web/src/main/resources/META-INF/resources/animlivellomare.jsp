...
<section id="map-section--dato-osservato--radar"
	...
	<div class="map-section__body">
		<div
			class="map-component map-component--data map-component--dato-osservato--livellomare"
			id="map-component--dato-osservato--livellomare" data-toggle="data-map"
			data-scenarios="livellomare">
				...
				<div class="row flex-column-reverse flex-md-row map-toolbar">
					...
					<div class="col-12 col-md-6">
						...
						<div class="map-toolbar__datetime">
							...
							<div class="form-group">
								...
								<label for="datetimepicker--dato-osservato--livellomare__field"><liferay-ui:message key="allertaanimazionemeteo_giorno" />
								</label>
								<div class="input-group date"
									id="datetimepicker--dato-osservato--livellomare"
									data-toggle="datetimepicker">

									<input type="text"
										id="datetimepicker--dato-osservato--livellomare__field"
										class="form-control datetimepicker-input" /> <a
										class="input-group-append datepickerbutton"
										href="#datetimepicker--dato-osservato--livellomare">
					...
					<div class="col-12 col-md-6">
						<div class="map-toolbar__timewheel-player"
							id="map-toolbar__timewheel-player--dato-osservato--livellomare">
			...
			<div class="u-map-section__map-side map-component__map"
				id="map--dato-osservato--livellomare">
							...
							<div class="d-flex">
								<div class="d-none d-md-flex d-print-flex flex-md-row">
									<div class="map-legend--rtdata-legend">
										<strong><liferay-ui:message key="allertaanimazionemeteo_livmare" /></strong>
					...
					<div class="row flex-lg-column">
						...
						<div class="col-12 col-lg-7 mb-4" data-if="legend"
							...
							<ul class="mb-md-2 nav map-legend__rtdata-guides flex-column">
								...
								<li class="nav-item" data-if="legend" data-when="livellomare">
									<div class="nav-span d-flex flex-column mb-3">
										<strong><liferay-ui:message key="allertaanimazionemeteo_livmare" /></strong>
									</div>
								</li>
						...
						<div class="col-12 col-lg-5 mb-4">
							...
							<ul class="mb-md-2 nav map-legend__utility-guides flex-column">
								<li class="nav-item"><a class="nav-link" href="/documents/20181/1138904/Guida_mappa_livello_mare.pdf"
