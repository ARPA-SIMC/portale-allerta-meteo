   ...
   <div class="container page__body">
	 ...
	 <div class="row">
		...
		<div class="col-12 page__content" id="page-content">
			...
			<p>
				...
				modello numerico 
				<a href="/documents/20181/1138904/Modellistica+dello+stato+del+mare_170118.pdf/89e749f8-0862-9bb0-d08c-214bf21225c0">SWAN (Simulating Wave Nearshore).</a>
			
				Per stato del mare si intende la descrizione delle proprietà
				...
				si definisce altezza significativa la media del terzo più alto.
			...
			<div class="row flex-column-reverse flex-md-row map-toolbar" style="">
				...
				<div class="col-12 col-md-6">
					...
					<div class="map-toolbar__timewheel-player"
						id="#map-toolbar__timewheel-player--dato-osservato--animmare">
	...
	<div class="row flex-column-reverse flex-md-row">		
		...
		<div class="col-6">
			...
			Servizio Meteorologico della Marina Britannica, è utilizzata in
