...
<section id="map-section--dato-osservato--radar"
	...
	<div class="map-section__body">
		<div
			class="map-component map-component--data map-component--dato-osservato--umidita"
			id="map-component--dato-osservato--umidita" data-toggle="data-map"
			data-scenarios="umidita">
				...
				<div class="row flex-column-reverse flex-md-row map-toolbar">
						...
						<div class="map-toolbar__datetime">
							...
							<div class="form-group">
								...
								<div class="input-group date"
									...
									<input type="text"
										id="datetimepicker--dato-osservato--umidita__field"
										class="form-control datetimepicker-input" /> <a
										class="input-group-append datepickerbutton"
										href="#datetimepicker--dato-osservato--umidita">
					...
					<div class="col-12 col-md-6">
						<div class="map-toolbar__timewheel-player"
							id="map-toolbar__timewheel-player--dato-osservato--umidita">
