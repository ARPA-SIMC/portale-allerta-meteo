	...
	<div class="container d-flex">
		...
		<div class="row w-100 justify-content-between">
			<div class="col-10 col-lg-10">
				<h1>Pioggia cumulata 48h</h1>
				<p class="lead">Precipitazione cumulata nelle 48 ore precedenti
...
<section id="map-section--dato-osservato--cumulata-48h"	class="container map-section map-section--full-width">


	<div class="map-section__body">

		<div
			class="map-component map-component--data map-component--dato-osservato--cumulata-48h"
			id="map-component--dato-osservato--cumulata-48h"
			data-toggle="data-map" data-scenarios="cumulata-48h">
				...
				<div class="row flex-column-reverse flex-md-row map-toolbar">
					<div class="col-12 col-md-6">
						<div class="map-toolbar__animation">
							<div class="form-group map-animation-dropdown">
								<label for="animation__timespan--dato-osservato--cumulata-48h">
									Animazione </label>
								<div class="input-group">
									<select id="animation__timespan--dato-osservato--cumulata-48h"
											class="form-control map-animation__timespan">
									</select>
									<div class="input-group-append">
										<a
											href="#map-toolbar__time-player--dato-osservato--cumulata-48h"
											title="Lancia/Ferma l'animazione"
											data-source="#animation__timespan--dato-osservato--cumulata-48h"
					...
					<div class="col-12 col-md-6">
						<div class="map-toolbar__timewheel-player"
							id="#map-toolbar__timewheel-player--dato-osservato--cumulata-48h">
			...
			<div
				...
				id="map--dato-osservato--cumulata-48h" tabindex="0"
				style="display: none;">
