...
public interface AnimeteoImgLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AnimeteoImgLocalServiceUtil} to access the animeteo img local service. Add custom service methods to <code>it.eng.animaeteo.service.impl.AnimeteoImgLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
