...
/**
 * Provides the local service interface for AnimeteoSmallImg. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author UTENTE
 * @see AnimeteoSmallImgLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface AnimeteoSmallImgLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>it.eng.animaeteo.service.impl.AnimeteoSmallImgLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the animeteo small img local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AnimeteoSmallImgLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public List<AnimeteoSmallImg> findByType(String type)
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AnimeteoSmallImg getAnimeteoSmallImg(long id) throws PortalException;
