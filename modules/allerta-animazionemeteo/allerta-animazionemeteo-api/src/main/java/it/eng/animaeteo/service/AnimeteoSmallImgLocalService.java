...
public interface AnimeteoSmallImgLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AnimeteoSmallImgLocalServiceUtil} to access the animeteo small img local service. Add custom service methods to <code>it.eng.animaeteo.service.impl.AnimeteoSmallImgLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
