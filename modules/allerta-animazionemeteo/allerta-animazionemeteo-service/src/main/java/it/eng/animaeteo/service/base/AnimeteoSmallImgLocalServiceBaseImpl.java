...
public abstract class AnimeteoSmallImgLocalServiceBaseImpl
	...
	implements AnimeteoSmallImgLocalService, AopService,
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return animeteoSmallImgPersistence.dslQuery(dslQuery);
	}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return animeteoSmallImgPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement AnimeteoSmallImgLocalServiceImpl#deleteAnimeteoSmallImg(AnimeteoSmallImg) to avoid orphaned data");
		}
	...
	@Override
	public BasePersistence<AnimeteoSmallImg> getBasePersistence() {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AnimeteoSmallImgLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		animeteoSmallImgLocalService = (AnimeteoSmallImgLocalService)aopProxy;
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AnimeteoSmallImgLocalServiceBaseImpl.class);
