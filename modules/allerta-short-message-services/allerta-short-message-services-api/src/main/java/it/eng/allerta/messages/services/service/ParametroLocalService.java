...
public interface ParametroLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ParametroLocalServiceUtil} to access the parametro local service. Add custom service methods to <code>it.eng.allerta.messages.services.service.impl.ParametroLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
