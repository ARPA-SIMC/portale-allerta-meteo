...
public interface NodoLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link NodoLocalServiceUtil} to access the nodo local service. Add custom service methods to <code>it.eng.allerta.messages.services.service.impl.NodoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
