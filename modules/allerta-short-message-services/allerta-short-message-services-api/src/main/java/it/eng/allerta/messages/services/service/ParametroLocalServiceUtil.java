...
public class ParametroLocalServiceUtil {
	 ...
	 */
	public static it.eng.allerta.messages.services.model.Parametro addParametro(
	 ...
	 */
	public static it.eng.allerta.messages.services.model.Parametro
		createParametro(long Id) {
	...
	public static it.eng.allerta.messages.services.model.Parametro
		fetchParametro(long Id) {

		return getService().fetchParametro(Id);
	}

	public static java.util.List<Long> fetchSmsStatoTre() {
		return getService().fetchSmsStatoTre();
	}

	public static java.util.List
		<it.eng.allerta.messages.services.model.Parametro> findBynodo(
				String nodo)
	 ...
	 * @throws PortalException if a parametro with the primary key could not be found
	 */
	public static it.eng.allerta.messages.services.model.Parametro getParametro(
			long Id)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	public static java.util.List
		<it.eng.allerta.messages.services.model.Parametro> getParametros(
			int start, int end) {
