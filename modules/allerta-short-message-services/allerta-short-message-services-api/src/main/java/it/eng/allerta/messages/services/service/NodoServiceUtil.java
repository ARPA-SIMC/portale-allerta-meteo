...
public class NodoServiceUtil {
	...
	private static ServiceTracker<NodoService, NodoService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(NodoService.class);

		ServiceTracker<NodoService, NodoService> serviceTracker =
			new ServiceTracker<NodoService, NodoService>(
				bundle.getBundleContext(), NodoService.class, null);
