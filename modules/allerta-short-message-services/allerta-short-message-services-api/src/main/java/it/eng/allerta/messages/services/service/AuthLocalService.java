...
public interface AuthLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AuthLocalServiceUtil} to access the auth local service. Add custom service methods to <code>it.eng.allerta.messages.services.service.impl.AuthLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
