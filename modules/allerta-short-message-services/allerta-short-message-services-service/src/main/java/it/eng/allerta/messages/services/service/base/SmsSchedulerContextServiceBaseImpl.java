...
import it.eng.allerta.messages.services.service.SmsSchedulerContextService;
...
/**
 * Provides the base implementation for the sms scheduler context remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.eng.allerta.messages.services.service.impl.SmsSchedulerContextServiceImpl}.
 * </p>
 *
 * @author Giorgianni_F
 * @see it.eng.allerta.messages.services.service.impl.SmsSchedulerContextServiceImpl
 * @generated
 */
public abstract class SmsSchedulerContextServiceBaseImpl
	extends BaseServiceImpl
	implements SmsSchedulerContextService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SmsSchedulerContextService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>it.eng.allerta.messages.services.service.SmsSchedulerContextServiceUtil</code>.
	 */
	 ...
	 */
	public it.eng.allerta.messages.services.service.CounterSmsService
		getCounterSmsService() {
	 ...
	 */
	public void setCounterSmsService(
		it.eng.allerta.messages.services.service.CounterSmsService
			counterSmsService) {
	 ...
	 */
	public SmsSchedulerContextService getSmsSchedulerContextService() {
	...
	public String getOSGiServiceIdentifier() {
		return SmsSchedulerContextService.class.getName();
	}
	...
	@BeanReference(
		type = it.eng.allerta.messages.services.service.CounterSmsService.class
	)
	protected it.eng.allerta.messages.services.service.CounterSmsService
		counterSmsService;
	...
	@BeanReference(type = SmsSchedulerContextService.class)
	protected SmsSchedulerContextService smsSchedulerContextService;
