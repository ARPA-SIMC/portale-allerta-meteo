...
package it.eng.parer.service.persistence.impl.constants;

/**
 * @author Pratola_L
 * @generated
 */
public class parerPersistenceConstants {

	public static final String BUNDLE_SYMBOLIC_NAME = "it.eng.parer.service";
