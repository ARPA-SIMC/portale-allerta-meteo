...
public abstract class DocumentiCollegatiServiceBaseImpl
	...
	implements DocumentiCollegatiService, IdentifiableOSGiService {
	 ...
	 */
	public it.eng.parer.service.DatiSpecificiInvioService
		getDatiSpecificiInvioService() {
	...
	public void setDatiSpecificiInvioService(
		it.eng.parer.service.DatiSpecificiInvioService
			datiSpecificiInvioService) {
	 ...
	 */
	public DocumentiCollegatiService getDocumentiCollegatiService() {
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				documentiCollegatiPersistence.getDataSource();
	...
	@BeanReference(type = it.eng.parer.service.DatiSpecificiInvioService.class)
	protected it.eng.parer.service.DatiSpecificiInvioService
		datiSpecificiInvioService;
	...
	@BeanReference(type = DocumentiCollegatiService.class)
