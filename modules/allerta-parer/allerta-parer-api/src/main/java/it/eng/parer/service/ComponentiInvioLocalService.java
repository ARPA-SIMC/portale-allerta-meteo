...
public interface ComponentiInvioLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>it.eng.parer.service.impl.ComponentiInvioLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the componenti invio local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ComponentiInvioLocalServiceUtil} if injection and service tracking are not available.
	 */
