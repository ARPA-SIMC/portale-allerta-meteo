...
/**
 * Provides the local service interface for Parametri. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Pratola_L
 * @see ParametriLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ParametriLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>it.eng.parer.service.impl.ParametriLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the parametri local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ParametriLocalServiceUtil} if injection and service tracking are not available.
	 */
