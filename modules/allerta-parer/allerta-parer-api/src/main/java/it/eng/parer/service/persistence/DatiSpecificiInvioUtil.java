...
public class DatiSpecificiInvioUtil {
	...
	public static List<DatiSpecificiInvio> findByesitoInvio(
		...
		return getPersistence().findByesitoInvio(
			ESITO_INVIO, start, end, orderByComparator, useFinderCache);
	}
	...
	public static void setPersistence(
		DatiSpecificiInvioPersistence persistence) {

		_persistence = persistence;
	}

	private static volatile DatiSpecificiInvioPersistence _persistence;
