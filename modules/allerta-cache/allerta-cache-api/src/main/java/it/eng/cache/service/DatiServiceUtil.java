...
public class DatiServiceUtil {
	...
	private static ServiceTracker<DatiService, DatiService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(DatiService.class);

		ServiceTracker<DatiService, DatiService> serviceTracker =
			new ServiceTracker<DatiService, DatiService>(
				bundle.getBundleContext(), DatiService.class, null);
