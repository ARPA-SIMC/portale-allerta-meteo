...
public interface RubricaLogLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link RubricaLogLocalServiceUtil} to access the rubrica log local service. Add custom service methods to <code>it.eng.allerte.service.impl.RubricaLogLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
