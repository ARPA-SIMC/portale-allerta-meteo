...
public class RubricaLogServiceUtil {
	 ...
	 */
	public static java.util.Map<String, Object> getLogs(
	...
	private static ServiceTracker<RubricaLogService, RubricaLogService>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(RubricaLogService.class);

		ServiceTracker<RubricaLogService, RubricaLogService> serviceTracker =
			new ServiceTracker<RubricaLogService, RubricaLogService>(
				bundle.getBundleContext(), RubricaLogService.class, null);
