...
public interface RubricaGruppoGruppiLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link RubricaGruppoGruppiLocalServiceUtil} to access the rubrica gruppo gruppi local service. Add custom service methods to <code>it.eng.allerte.service.impl.RubricaGruppoGruppiLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
