...
public class RubricaNominativoLocalServiceUtil {
	 ...
	 */
	public static it.eng.allerte.model.RubricaNominativo addRubricaNominativo(
	 ...
	 */
	public static it.eng.allerte.model.RubricaNominativo
		createRubricaNominativo(long ID_NOMINATIVO) {
	 ...
	 */
	public static it.eng.allerte.model.RubricaNominativo
			deleteRubricaNominativo(long ID_NOMINATIVO)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	public static it.eng.allerte.model.RubricaNominativo fetchRubricaNominativo(
		long ID_NOMINATIVO) {
	...
	public static java.util.List<Object[]> getNominativiByName(
	 ...
	 * @throws PortalException if a rubrica nominativo with the primary key could not be found
	 */
	public static it.eng.allerte.model.RubricaNominativo getRubricaNominativo(
			long ID_NOMINATIVO)
		throws com.liferay.portal.kernel.exception.PortalException {
					...
					new ServiceTracker
						<RubricaNominativoLocalService,
						 RubricaNominativoLocalService>(
							 ...
							 RubricaNominativoLocalService.class, null);
