...
public class RubricaCanaleServiceUtil {
	...
	private static ServiceTracker<RubricaCanaleService, RubricaCanaleService>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(RubricaCanaleService.class);

		ServiceTracker<RubricaCanaleService, RubricaCanaleService>
			serviceTracker =
				new ServiceTracker<RubricaCanaleService, RubricaCanaleService>(
					bundle.getBundleContext(), RubricaCanaleService.class,
					null);
