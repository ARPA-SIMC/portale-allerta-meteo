...
public class RubricaRuoloLocalServiceUtil {
	 ...
	 */
	public static RubricaRuolo addRubricaRuolo(RubricaRuolo rubricaRuolo) {
	 ...
	 */
	public static RubricaRuolo createRubricaRuolo(long ID_RUOLO) {
	 ...
	 */
	public static RubricaRuolo deleteRubricaRuolo(long ID_RUOLO)
		throws PortalException {
	 ...
	 * @return the rubrica ruolo that was removed
	 */
	public static RubricaRuolo deleteRubricaRuolo(RubricaRuolo rubricaRuolo) {
	...
	public static RubricaRuolo fetchRubricaRuolo(long ID_RUOLO) {
	 ...
	 * @throws PortalException if a rubrica ruolo with the primary key could not be found
	 */
	public static RubricaRuolo getRubricaRuolo(long ID_RUOLO)
		throws PortalException {
	 ...
	 */
	public static List<RubricaRuolo> getRubricaRuolos(int start, int end) {
	 ...
	 */
	public static RubricaRuolo updateRubricaRuolo(RubricaRuolo rubricaRuolo) {
	...
	private static final Snapshot<RubricaRuoloLocalService> _serviceSnapshot =
		new Snapshot<>(
			RubricaRuoloLocalServiceUtil.class, RubricaRuoloLocalService.class);
