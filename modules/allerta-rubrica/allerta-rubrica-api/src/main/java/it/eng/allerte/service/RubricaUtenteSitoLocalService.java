...
public interface RubricaUtenteSitoLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link RubricaUtenteSitoLocalServiceUtil} to access the rubrica utente sito local service. Add custom service methods to <code>it.eng.allerte.service.impl.RubricaUtenteSitoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
