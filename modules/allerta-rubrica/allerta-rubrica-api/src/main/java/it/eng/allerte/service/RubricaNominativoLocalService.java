...
public interface RubricaNominativoLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link RubricaNominativoLocalServiceUtil} to access the rubrica nominativo local service. Add custom service methods to <code>it.eng.allerte.service.impl.RubricaNominativoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
