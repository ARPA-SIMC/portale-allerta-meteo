...
/**
 * Provides the local service interface for RubricaNominativo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Pratola_L
 * @see RubricaNominativoLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface RubricaNominativoLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>it.eng.allerte.service.impl.RubricaNominativoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the rubrica nominativo local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link RubricaNominativoLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Object[]> getNominativiByName(
