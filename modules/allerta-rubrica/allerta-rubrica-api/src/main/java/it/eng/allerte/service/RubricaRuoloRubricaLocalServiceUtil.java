...
public class RubricaRuoloRubricaLocalServiceUtil {
	 ...
	 */
	public static RubricaRuoloRubrica addRubricaRuoloRubrica(
	 ...
	 */
	public static RubricaRuoloRubrica createRubricaRuoloRubrica(long ID_RUOLO) {
	 ...
	 */
	public static RubricaRuoloRubrica deleteRubricaRuoloRubrica(long ID_RUOLO)
		throws PortalException {
	 ...
	 * @return the rubrica ruolo rubrica that was removed
	 */
	public static RubricaRuoloRubrica deleteRubricaRuoloRubrica(
		RubricaRuoloRubrica rubricaRuoloRubrica) {
	...
	public static RubricaRuoloRubrica fetchRubricaRuoloRubrica(long ID_RUOLO) {
	 ...
	 * @throws PortalException if a rubrica ruolo rubrica with the primary key could not be found
	 */
	public static RubricaRuoloRubrica getRubricaRuoloRubrica(long ID_RUOLO)
		throws PortalException {
	 ...
	 */
	public static List<RubricaRuoloRubrica> getRubricaRuoloRubricas(
		int start, int end) {
	 ...
	 */
	public static RubricaRuoloRubrica updateRubricaRuoloRubrica(
		RubricaRuoloRubrica rubricaRuoloRubrica) {
	...
	private static final Snapshot<RubricaRuoloRubricaLocalService>
		_serviceSnapshot = new Snapshot<>(
			RubricaRuoloRubricaLocalServiceUtil.class,
