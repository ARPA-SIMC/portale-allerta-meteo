...
public interface RubricaCanaleLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link RubricaCanaleLocalServiceUtil} to access the rubrica canale local service. Add custom service methods to <code>it.eng.allerte.service.impl.RubricaCanaleLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
