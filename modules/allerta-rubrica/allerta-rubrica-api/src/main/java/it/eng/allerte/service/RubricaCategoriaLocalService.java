...
public interface RubricaCategoriaLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link RubricaCategoriaLocalServiceUtil} to access the rubrica categoria local service. Add custom service methods to <code>it.eng.allerte.service.impl.RubricaCategoriaLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
