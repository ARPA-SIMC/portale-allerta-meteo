...
public interface RubricaSitoLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link RubricaSitoLocalServiceUtil} to access the rubrica sito local service. Add custom service methods to <code>it.eng.allerte.service.impl.RubricaSitoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
