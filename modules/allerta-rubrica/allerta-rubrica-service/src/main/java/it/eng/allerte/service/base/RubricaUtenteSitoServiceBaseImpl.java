...
public abstract class RubricaUtenteSitoServiceBaseImpl
	...
	implements AopService, IdentifiableOSGiService, RubricaUtenteSitoService {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			RubricaUtenteSitoService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		rubricaUtenteSitoService = (RubricaUtenteSitoService)aopProxy;
	}
	...
	protected void runSQL(String sql) {
		DataSource dataSource = rubricaUtenteSitoPersistence.getDataSource();
	...
	private static final Log _log = LogFactoryUtil.getLog(
		RubricaUtenteSitoServiceBaseImpl.class);
