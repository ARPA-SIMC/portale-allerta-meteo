...
public abstract class RubricaUtenteSitoLocalServiceBaseImpl
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return rubricaUtenteSitoPersistence.dslQuery(dslQuery);
	}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return rubricaUtenteSitoPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement RubricaUtenteSitoLocalServiceImpl#deleteRubricaUtenteSito(RubricaUtenteSito) to avoid orphaned data");
		}
	...
	@Override
	public BasePersistence<RubricaUtenteSito> getBasePersistence() {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			RubricaUtenteSitoLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		rubricaUtenteSitoLocalService = (RubricaUtenteSitoLocalService)aopProxy;
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		RubricaUtenteSitoLocalServiceBaseImpl.class);
