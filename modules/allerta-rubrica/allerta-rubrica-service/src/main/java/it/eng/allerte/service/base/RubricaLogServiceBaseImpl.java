...
public abstract class RubricaLogServiceBaseImpl
	...
	implements AopService, IdentifiableOSGiService, RubricaLogService {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			RubricaLogService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		rubricaLogService = (RubricaLogService)aopProxy;
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		RubricaLogServiceBaseImpl.class);
