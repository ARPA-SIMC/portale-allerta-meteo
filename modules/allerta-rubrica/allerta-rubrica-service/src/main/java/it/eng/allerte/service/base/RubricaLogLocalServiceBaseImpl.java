...
public abstract class RubricaLogLocalServiceBaseImpl
	...
	implements RubricaLogLocalService, IdentifiableOSGiService {
	 ...
	 */
	public RubricaLogLocalService getRubricaLogLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"it.eng.allerte.model.RubricaLog", rubricaLogLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"it.eng.allerte.model.RubricaLog");
	}
	...
	@BeanReference(type = RubricaLogLocalService.class)
