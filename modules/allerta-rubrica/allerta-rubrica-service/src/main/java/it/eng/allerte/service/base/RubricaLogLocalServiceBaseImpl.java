...
import it.eng.allerte.service.RubricaLogLocalService;
...
/**
 * Provides the base implementation for the rubrica log local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.eng.allerte.service.impl.RubricaLogLocalServiceImpl}.
 * </p>
 *
 * @author Pratola_L
 * @see it.eng.allerte.service.impl.RubricaLogLocalServiceImpl
 * @generated
 */
public abstract class RubricaLogLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, RubricaLogLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>RubricaLogLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>it.eng.allerte.service.RubricaLogLocalServiceUtil</code>.
	 */
	...
	public RubricaLog addRubricaLog(RubricaLog rubricaLog) {
		...
		return rubricaLogPersistence.update(rubricaLog);
	}
	...
	public RubricaLog createRubricaLog(long ID_LOG) {
		return rubricaLogPersistence.create(ID_LOG);
	}
	...
	public RubricaLog deleteRubricaLog(long ID_LOG) throws PortalException {
		return rubricaLogPersistence.remove(ID_LOG);
	}
	...
	public RubricaLog deleteRubricaLog(RubricaLog rubricaLog) {
		return rubricaLogPersistence.remove(rubricaLog);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return rubricaLogPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			RubricaLog.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return rubricaLogPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return rubricaLogPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return rubricaLogPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return rubricaLogPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public RubricaLog fetchRubricaLog(long ID_LOG) {
		return rubricaLogPersistence.fetchByPrimaryKey(ID_LOG);
	}
	...
	public RubricaLog getRubricaLog(long ID_LOG) throws PortalException {
		return rubricaLogPersistence.findByPrimaryKey(ID_LOG);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(rubricaLogLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(RubricaLog.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("ID_LOG");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(RubricaLog.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("ID_LOG");
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return rubricaLogPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement RubricaLogLocalServiceImpl#deleteRubricaLog(RubricaLog) to avoid orphaned data");
		}

		return rubricaLogLocalService.deleteRubricaLog(
			(RubricaLog)persistedModel);
	}

	@Override
	public BasePersistence<RubricaLog> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return rubricaLogPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<RubricaLog> getRubricaLogs(int start, int end) {
		return rubricaLogPersistence.findAll(start, end);
	}
	...
	public int getRubricaLogsCount() {
		return rubricaLogPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			RubricaLogLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		rubricaLogLocalService = (RubricaLogLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return RubricaLogLocalService.class.getName();
	}
	...
	protected RubricaLogLocalService rubricaLogLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		RubricaLogLocalServiceBaseImpl.class);
