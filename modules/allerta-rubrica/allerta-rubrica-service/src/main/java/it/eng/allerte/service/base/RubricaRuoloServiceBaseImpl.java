...
public abstract class RubricaRuoloServiceBaseImpl
	...
	implements AopService, IdentifiableOSGiService, RubricaRuoloService {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			RubricaRuoloService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		rubricaRuoloService = (RubricaRuoloService)aopProxy;
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		RubricaRuoloServiceBaseImpl.class);
