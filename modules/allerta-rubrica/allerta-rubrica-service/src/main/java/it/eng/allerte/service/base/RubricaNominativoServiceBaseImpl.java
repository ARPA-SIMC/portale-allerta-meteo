...
public abstract class RubricaNominativoServiceBaseImpl
	...
	implements AopService, IdentifiableOSGiService, RubricaNominativoService {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			RubricaNominativoService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		rubricaNominativoService = (RubricaNominativoService)aopProxy;
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		RubricaNominativoServiceBaseImpl.class);
