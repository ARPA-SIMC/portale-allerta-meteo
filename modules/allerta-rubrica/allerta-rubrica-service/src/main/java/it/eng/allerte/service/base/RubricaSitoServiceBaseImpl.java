...
public abstract class RubricaSitoServiceBaseImpl
	...
	implements AopService, IdentifiableOSGiService, RubricaSitoService {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			RubricaSitoService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		rubricaSitoService = (RubricaSitoService)aopProxy;
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		RubricaSitoServiceBaseImpl.class);
