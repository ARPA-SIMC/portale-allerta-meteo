...
public abstract class RubricaCategoriaServiceBaseImpl
	...
	implements AopService, IdentifiableOSGiService, RubricaCategoriaService {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			RubricaCategoriaService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		rubricaCategoriaService = (RubricaCategoriaService)aopProxy;
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		RubricaCategoriaServiceBaseImpl.class);
