...
import it.eng.allerte.service.RubricaCategoriaService;
...
/**
 * Provides the base implementation for the rubrica categoria remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.eng.allerte.service.impl.RubricaCategoriaServiceImpl}.
 * </p>
 *
 * @author Pratola_L
 * @see it.eng.allerte.service.impl.RubricaCategoriaServiceImpl
 * @generated
 */
public abstract class RubricaCategoriaServiceBaseImpl
	extends BaseServiceImpl
	implements RubricaCategoriaService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>RubricaCategoriaService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>it.eng.allerte.service.RubricaCategoriaServiceUtil</code>.
	 */
	 ...
	 */
	public RubricaCategoriaService getRubricaCategoriaService() {
	 ...
	 */
	public it.eng.allerte.service.RubricaSitoService getRubricaSitoService() {
	 ...
	 */
	public void setRubricaSitoService(
		it.eng.allerte.service.RubricaSitoService rubricaSitoService) {
	...
	public String getOSGiServiceIdentifier() {
		return RubricaCategoriaService.class.getName();
	}
	...
	@BeanReference(type = RubricaCategoriaService.class)
	protected RubricaCategoriaService rubricaCategoriaService;
	...
	@BeanReference(type = it.eng.allerte.service.RubricaSitoService.class)
	protected it.eng.allerte.service.RubricaSitoService rubricaSitoService;
