...
public abstract class RubricaCanaleLocalServiceBaseImpl
	...
	implements RubricaCanaleLocalService, IdentifiableOSGiService {
	 ...
	 */
	public RubricaCanaleLocalService getRubricaCanaleLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"it.eng.allerte.model.RubricaCanale", rubricaCanaleLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"it.eng.allerte.model.RubricaCanale");
	}
	...
	@BeanReference(type = RubricaCanaleLocalService.class)
