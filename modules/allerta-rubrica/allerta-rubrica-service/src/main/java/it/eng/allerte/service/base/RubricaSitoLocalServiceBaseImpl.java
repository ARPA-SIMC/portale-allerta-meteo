...
public abstract class RubricaSitoLocalServiceBaseImpl
	...
	implements RubricaSitoLocalService, IdentifiableOSGiService {
	 ...
	 */
	public RubricaSitoLocalService getRubricaSitoLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"it.eng.allerte.model.RubricaSito", rubricaSitoLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"it.eng.allerte.model.RubricaSito");
	}
	...
	@BeanReference(type = RubricaSitoLocalService.class)
