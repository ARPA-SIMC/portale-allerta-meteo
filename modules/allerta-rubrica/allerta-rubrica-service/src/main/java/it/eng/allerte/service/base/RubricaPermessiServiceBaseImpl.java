...
public abstract class RubricaPermessiServiceBaseImpl
	...
	implements AopService, IdentifiableOSGiService, RubricaPermessiService {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			RubricaPermessiService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		rubricaPermessiService = (RubricaPermessiService)aopProxy;
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		RubricaPermessiServiceBaseImpl.class);
