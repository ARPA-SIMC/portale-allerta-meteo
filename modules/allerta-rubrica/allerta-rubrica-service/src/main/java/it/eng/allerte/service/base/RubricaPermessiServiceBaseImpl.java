...
import it.eng.allerte.service.RubricaPermessiService;
...
/**
 * Provides the base implementation for the rubrica permessi remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.eng.allerte.service.impl.RubricaPermessiServiceImpl}.
 * </p>
 *
 * @author Pratola_L
 * @see it.eng.allerte.service.impl.RubricaPermessiServiceImpl
 * @generated
 */
public abstract class RubricaPermessiServiceBaseImpl
	extends BaseServiceImpl
	implements RubricaPermessiService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>RubricaPermessiService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>it.eng.allerte.service.RubricaPermessiServiceUtil</code>.
	 */
	 ...
	 */
	public RubricaPermessiService getRubricaPermessiService() {
	...
	public String getOSGiServiceIdentifier() {
		return RubricaPermessiService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = rubricaPermessiPersistence.getDataSource();
	...
	@BeanReference(type = RubricaPermessiService.class)
	protected RubricaPermessiService rubricaPermessiService;
