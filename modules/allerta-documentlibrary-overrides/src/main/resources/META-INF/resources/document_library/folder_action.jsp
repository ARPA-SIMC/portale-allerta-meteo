...
boolean mostraWebdav = false;
if (u!=null) {
	List<Role> ruoli = RoleLocalServiceUtil.getUserRoles(u.getUserId());
	for (Role rl : ruoli) {
		if (rl.getRoleId()==20161 || rl.getRoleId()==168321) mostraWebdav = true;
	}
}
...
<c:if test="<%= dlPortletInstanceSettingsHelper.isShowActions() %>">
	...
	>
		...
		<c:if test="<%= mostraWebdav && hasViewPermission && portletDisplay.isWebDAVEnabled() && ((folder == null) || (folder.getRepositoryId() == scopeGroupId)) %>">
