...
public class CounterSmsUtil {
	 ...
	 * @return the matching counter sms, or <code>null</code> if a matching counter sms could not be found
	 */
	public static CounterSms fetchBydata(Date date, boolean useFinderCache) {
		return getPersistence().fetchBydata(date, useFinderCache);
	}
	...
	public static List<CounterSms> findBydataAndNodo(
		...
		return getPersistence().findBydataAndNodo(
			date, nodo, start, end, orderByComparator, useFinderCache);
	}
	...
	public static void setPersistence(CounterSmsPersistence persistence) {
		_persistence = persistence;
	}

	private static volatile CounterSmsPersistence _persistence;
