...
/**
 * Provides the local service interface for Auth. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Giorgianni_F
 * @see AuthLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface AuthLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>it.eng.allerta.messages.services.service.impl.AuthLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the auth local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AuthLocalServiceUtil} if injection and service tracking are not available.
	 */
