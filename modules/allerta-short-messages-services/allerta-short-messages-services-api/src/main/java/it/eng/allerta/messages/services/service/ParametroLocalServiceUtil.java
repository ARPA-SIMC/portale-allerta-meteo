 ...
 * <code>it.eng.allerta.messages.services.service.impl.ParametroLocalServiceImpl</code> and
...
public class ParametroLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>it.eng.allerta.messages.services.service.impl.ParametroLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Parametro addParametro(Parametro parametro) {
	 ...
	 */
	public static Parametro createParametro(long Id) {
		return getService().createParametro(Id);
	}
	 ...
	 */
	public static Parametro deleteParametro(long Id) throws PortalException {
		return getService().deleteParametro(Id);
	}
	 ...
	 * @return the parametro that was removed
	 */
	public static Parametro deleteParametro(Parametro parametro) {
	...
	public static Parametro fetchParametro(long Id) {
		return getService().fetchParametro(Id);
	}

	public static List<Long> fetchSmsStatoTre() {
		return getService().fetchSmsStatoTre();
	}

	public static List<Parametro> findBynodo(String nodo)
		throws SystemException {

		return getService().findBynodo(nodo);
	}
	 ...
	 * @throws PortalException if a parametro with the primary key could not be found
	 */
	public static Parametro getParametro(long Id) throws PortalException {
		return getService().getParametro(Id);
	}
	 ...
	 */
	public static List<Parametro> getParametros(int start, int end) {
	...
	public static void resetSMSFaseThree() {
		getService().resetSMSFaseThree();
	}

	public static void resetSMSFaseTwo() {
		getService().resetSMSFaseTwo();
	}
	 ...
	 */
	public static Parametro updateParametro(Parametro parametro) {
	...
	private static final Snapshot<ParametroLocalService> _serviceSnapshot =
		new Snapshot<>(
			ParametroLocalServiceUtil.class, ParametroLocalService.class);
