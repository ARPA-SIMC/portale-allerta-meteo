...
/**
 * Provides the local service interface for CounterSms. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Giorgianni_F
 * @see CounterSmsLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CounterSmsLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>it.eng.allerta.messages.services.service.impl.CounterSmsLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the counter sms local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link CounterSmsLocalServiceUtil} if injection and service tracking are not available.
	 */
