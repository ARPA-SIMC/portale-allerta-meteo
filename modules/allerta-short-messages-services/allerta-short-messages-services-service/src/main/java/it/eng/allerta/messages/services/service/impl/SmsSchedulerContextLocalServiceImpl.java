 ...
 */
@Component(
	property = "model.class.name=it.eng.allerta.messages.services.model.SmsSchedulerContext",
	service = AopService.class
)
public class SmsSchedulerContextLocalServiceImpl
	extends SmsSchedulerContextLocalServiceBaseImpl {
	...
	public boolean setSmsSchdulerContextInExclusiveMode(String querySQL, String varId, String value) throws SystemException {
		...
		try {
			...
			session = this.smsSchedulerContextPersistence.getCurrentSession();
