...
public abstract class ParametroServiceBaseImpl
	...
	implements AopService, IdentifiableOSGiService, ParametroService {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ParametroService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		parametroService = (ParametroService)aopProxy;
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ParametroServiceBaseImpl.class);
