...
public class AuthModelImpl extends BaseModelImpl<Auth> implements AuthModel {
	...
	private static class AttributeGetterFunctionsHolder {
		...
		static {
			...
			attributeGetterFunctions.put("key", Auth::getKey);
			attributeGetterFunctions.put("value", Auth::getValue);
	...
	private static class AttributeSetterBiConsumersHolder {
		...
		static {
			...
			attributeSetterBiConsumers.put(
				"key", (BiConsumer<Auth, String>)Auth::setKey);
			attributeSetterBiConsumers.put(
				"value", (BiConsumer<Auth, String>)Auth::setValue);
	...
	public Auth toEscapedModel() {
		if (_escapedModel == null) {
			Function<InvocationHandler, Auth>
	...
	public Auth cloneWithOriginalValues() {
		...
		authImpl.setKey(this.<String>getColumnOriginalValue("key_"));
		authImpl.setValue(this.<String>getColumnOriginalValue("value"));
	...
	public String toString() {
		...
		for (Map.Entry<String, Function<Auth, Object>> entry :
			...
			Object value = attributeGetterFunction.apply((Auth)this);
	...
	private static class EscapedModelProxyProviderFunctionHolder {
		...
		private static final Function<InvocationHandler, Auth>
			_escapedModelProxyProviderFunction =
	...
	public <T> T getColumnValue(String columnName) {
		...
		return (T)function.apply((Auth)this);
	}
