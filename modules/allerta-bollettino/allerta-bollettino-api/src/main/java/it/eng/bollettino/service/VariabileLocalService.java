...
public interface VariabileLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link VariabileLocalServiceUtil} to access the variabile local service. Add custom service methods to <code>it.eng.bollettino.service.impl.VariabileLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
