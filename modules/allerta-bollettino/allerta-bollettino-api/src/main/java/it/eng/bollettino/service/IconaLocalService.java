...
public interface IconaLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link IconaLocalServiceUtil} to access the icona local service. Add custom service methods to <code>it.eng.bollettino.service.impl.IconaLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
