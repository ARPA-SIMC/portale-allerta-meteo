...
/**
 * Provides the local service interface for BollettinoBacino. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author GFAVINI
 * @see BollettinoBacinoLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface BollettinoBacinoLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>it.eng.bollettino.service.impl.BollettinoBacinoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the bollettino bacino local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link BollettinoBacinoLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public BollettinoBacino addBollettinoBacino(
	...
	public BollettinoBacino createBollettinoBacino(long id);
	...
	public BollettinoBacino deleteBollettinoBacino(
		BollettinoBacino bollettinoBacino);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public BollettinoBacino deleteBollettinoBacino(long id)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public BollettinoBacino fetchBollettinoBacino(long id);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public BollettinoBacino getBollettinoBacino(long id) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<BollettinoBacino> getBollettinoBacinos(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public BollettinoBacino updateBollettinoBacino(
		BollettinoBacino bollettinoBacino);
