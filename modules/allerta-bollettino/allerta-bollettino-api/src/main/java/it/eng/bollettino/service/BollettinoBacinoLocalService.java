...
public interface BollettinoBacinoLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link BollettinoBacinoLocalServiceUtil} to access the bollettino bacino local service. Add custom service methods to <code>it.eng.bollettino.service.impl.BollettinoBacinoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
