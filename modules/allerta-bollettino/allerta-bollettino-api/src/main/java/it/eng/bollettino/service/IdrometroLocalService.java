...
public interface IdrometroLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link IdrometroLocalServiceUtil} to access the idrometro local service. Add custom service methods to <code>it.eng.bollettino.service.impl.IdrometroLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
