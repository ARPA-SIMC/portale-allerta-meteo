...
public class BollettinoSensoreLocalServiceUtil {
	 ...
	 */
	public static BollettinoSensore addBollettinoSensore(
	 ...
	 */
	public static BollettinoSensore createBollettinoSensore(long id) {
	 ...
	 */
	public static BollettinoSensore deleteBollettinoSensore(
		BollettinoSensore bollettinoSensore) {
	 ...
	 */
	public static BollettinoSensore deleteBollettinoSensore(long id)
		throws PortalException {
	...
	public static BollettinoSensore fetchBollettinoSensore(long id) {
	 ...
	 * @throws PortalException if a bollettino sensore with the primary key could not be found
	 */
	public static BollettinoSensore getBollettinoSensore(long id)
		throws PortalException {
	 ...
	 */
	public static List<BollettinoSensore> getBollettinoSensores(
		int start, int end) {
	 ...
	 */
	public static BollettinoSensore updateBollettinoSensore(
		BollettinoSensore bollettinoSensore) {
	...
	private static final Snapshot<BollettinoSensoreLocalService>
		_serviceSnapshot = new Snapshot<>(
			BollettinoSensoreLocalServiceUtil.class,
