...
public class ValoreSensoreServiceUtil {
	...
	private static ServiceTracker<ValoreSensoreService, ValoreSensoreService>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(ValoreSensoreService.class);

		ServiceTracker<ValoreSensoreService, ValoreSensoreService>
			serviceTracker =
				new ServiceTracker<ValoreSensoreService, ValoreSensoreService>(
					bundle.getBundleContext(), ValoreSensoreService.class,
					null);
