...
public class ImgWrapper implements Img, ModelWrapper<Img> {
	...
	@Override
	public int compareTo(it.eng.bollettino.model.Img img) {
	...
	public com.liferay.portal.kernel.model.CacheModel
		<it.eng.bollettino.model.Img> toCacheModel() {

		return _img.toCacheModel();
	}

	@Override
	public it.eng.bollettino.model.Img toEscapedModel() {
	...
	@Override
	public it.eng.bollettino.model.Img toUnescapedModel() {
