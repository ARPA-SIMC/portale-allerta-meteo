...
/**
 * Provides the local service interface for Pluviometro. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author GFAVINI
 * @see PluviometroLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface PluviometroLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>it.eng.bollettino.service.impl.PluviometroLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the pluviometro local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link PluviometroLocalServiceUtil} if injection and service tracking are not available.
	 */
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Pluviometro getPluviometro(String stazioneId) throws PortalException;
