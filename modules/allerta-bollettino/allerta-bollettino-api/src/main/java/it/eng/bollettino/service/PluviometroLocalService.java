...
public interface PluviometroLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link PluviometroLocalServiceUtil} to access the pluviometro local service. Add custom service methods to <code>it.eng.bollettino.service.impl.PluviometroLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
