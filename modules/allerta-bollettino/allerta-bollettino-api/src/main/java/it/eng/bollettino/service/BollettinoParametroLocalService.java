...
public interface BollettinoParametroLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link BollettinoParametroLocalServiceUtil} to access the bollettino parametro local service. Add custom service methods to <code>it.eng.bollettino.service.impl.BollettinoParametroLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
