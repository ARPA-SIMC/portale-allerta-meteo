...
public class StazioneVariabileLocalServiceWrapper
	implements ServiceWrapper<StazioneVariabileLocalService>,
	...
	public com.liferay.portal.kernel.model.PersistedModel createPersistedModel(
		...
		return _stazioneVariabileLocalService.createPersistedModel(
			primaryKeyObj);
	}
	...
	public <T> T dslQuery(com.liferay.petra.sql.dsl.query.DSLQuery dslQuery) {
		return _stazioneVariabileLocalService.dslQuery(dslQuery);
	}
	...
	public int dslQueryCount(
		...
		return _stazioneVariabileLocalService.dslQueryCount(dslQuery);
	}
	...
	public BasePersistence<?> getBasePersistence() {
		return _stazioneVariabileLocalService.getBasePersistence();
	}
