 ...
 * <code>it.eng.bollettino.service.impl.StazioneVariabileLocalServiceImpl</code> and
...
public class StazioneVariabileLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>it.eng.bollettino.service.impl.StazioneVariabileLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static it.eng.bollettino.cron.RisultatiAggiornamento
		...
		return getService().aggiornaSensori();
	}
	 ...
	 */
	public static int getStazioneVariabilesCount() {
		return getService().getStazioneVariabilesCount();
	}
