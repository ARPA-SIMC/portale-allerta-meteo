...
public class BollettinoBacinoLocalServiceUtil {
	 ...
	 */
	public static BollettinoBacino addBollettinoBacino(
	 ...
	 */
	public static BollettinoBacino createBollettinoBacino(long id) {
	 ...
	 */
	public static BollettinoBacino deleteBollettinoBacino(
		BollettinoBacino bollettinoBacino) {
	 ...
	 */
	public static BollettinoBacino deleteBollettinoBacino(long id)
		throws PortalException {
	...
	public static BollettinoBacino fetchBollettinoBacino(long id) {
	...
	public static List<BollettinoBacino> getBaciniByBollettino(
		long bollettinoId) {
	 ...
	 * @throws PortalException if a bollettino bacino with the primary key could not be found
	 */
	public static BollettinoBacino getBollettinoBacino(long id)
		throws PortalException {
	 ...
	 */
	public static List<BollettinoBacino> getBollettinoBacinos(
		int start, int end) {
	 ...
	 */
	public static BollettinoBacino updateBollettinoBacino(
		BollettinoBacino bollettinoBacino) {
	...
	private static final Snapshot<BollettinoBacinoLocalService>
		_serviceSnapshot = new Snapshot<>(
			BollettinoBacinoLocalServiceUtil.class,
