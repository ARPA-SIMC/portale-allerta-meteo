...
public interface BollettinoSensoreLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>it.eng.bollettino.service.impl.BollettinoSensoreLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the bollettino sensore local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link BollettinoSensoreLocalServiceUtil} if injection and service tracking are not available.
	 */
