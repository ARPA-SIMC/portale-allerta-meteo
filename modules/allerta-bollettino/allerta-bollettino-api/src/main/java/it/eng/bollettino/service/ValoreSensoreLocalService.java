...
public interface ValoreSensoreLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ValoreSensoreLocalServiceUtil} to access the valore sensore local service. Add custom service methods to <code>it.eng.bollettino.service.impl.ValoreSensoreLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
