...
/**
 * Provides the local service interface for Bacino. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author GFAVINI
 * @see BacinoLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface BacinoLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>it.eng.bollettino.service.impl.BacinoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the bacino local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link BacinoLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Bacino creaBacinoDefault(
