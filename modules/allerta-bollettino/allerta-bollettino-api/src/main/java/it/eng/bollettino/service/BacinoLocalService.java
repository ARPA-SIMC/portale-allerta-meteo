...
public interface BacinoLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link BacinoLocalServiceUtil} to access the bacino local service. Add custom service methods to <code>it.eng.bollettino.service.impl.BacinoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
