...
public class PluviometroUtil {
	...
	public static List<Pluviometro> findByNomeGruppo(
		...
		return getPersistence().findByNomeGruppo(
			nomeGruppo, start, end, orderByComparator, useFinderCache);
	}
	...
	public static void setPersistence(PluviometroPersistence persistence) {
		_persistence = persistence;
	}

	private static volatile PluviometroPersistence _persistence;
