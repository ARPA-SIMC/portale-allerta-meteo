...
public interface StazioneVariabileLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link StazioneVariabileLocalServiceUtil} to access the stazione variabile local service. Add custom service methods to <code>it.eng.bollettino.service.impl.StazioneVariabileLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
