...
/**
 * Provides the local service interface for StazioneVariabile. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author GFAVINI
 * @see StazioneVariabileLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface StazioneVariabileLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>it.eng.bollettino.service.impl.StazioneVariabileLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the stazione variabile local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link StazioneVariabileLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<StazioneVariabile> getStazioneVariabile(
