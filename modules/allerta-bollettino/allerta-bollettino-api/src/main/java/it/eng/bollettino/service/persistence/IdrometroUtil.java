...
public class IdrometroUtil {
	...
	public static List<Idrometro> findByNomeBacino(
		...
		return getPersistence().findByNomeBacino(
			nomeBacino, start, end, orderByComparator, useFinderCache);
	}
	...
	public static List<Idrometro> findByNomeSottobacino(
		...
		return getPersistence().findByNomeSottobacino(
			nomeSottobacino, start, end, orderByComparator, useFinderCache);
	}
	...
	public static List<Idrometro> findByNomeRubrica(
		...
		return getPersistence().findByNomeRubrica(
			nomeRubrica, start, end, orderByComparator, useFinderCache);
	}
	...
	public static void setPersistence(IdrometroPersistence persistence) {
		_persistence = persistence;
	}

	private static volatile IdrometroPersistence _persistence;
