...
public interface ImgLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ImgLocalServiceUtil} to access the img local service. Add custom service methods to <code>it.eng.bollettino.service.impl.ImgLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
