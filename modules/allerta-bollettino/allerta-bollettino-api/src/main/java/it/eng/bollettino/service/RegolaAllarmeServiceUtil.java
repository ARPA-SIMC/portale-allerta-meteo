...
public class RegolaAllarmeServiceUtil {
	...
	private static ServiceTracker<RegolaAllarmeService, RegolaAllarmeService>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(RegolaAllarmeService.class);

		ServiceTracker<RegolaAllarmeService, RegolaAllarmeService>
			serviceTracker =
				new ServiceTracker<RegolaAllarmeService, RegolaAllarmeService>(
					bundle.getBundleContext(), RegolaAllarmeService.class,
					null);
