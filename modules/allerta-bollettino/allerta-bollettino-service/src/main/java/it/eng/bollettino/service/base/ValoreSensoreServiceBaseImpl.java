...
/**
 * Provides the base implementation for the valore sensore remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.eng.bollettino.service.impl.ValoreSensoreServiceImpl}.
 * </p>
 *
 * @author GFAVINI
 * @see it.eng.bollettino.service.impl.ValoreSensoreServiceImpl
 * @generated
 */
public abstract class ValoreSensoreServiceBaseImpl
	extends BaseServiceImpl
	implements ValoreSensoreService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ValoreSensoreService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>it.eng.bollettino.service.ValoreSensoreServiceUtil</code>.
	 */
	 ...
	 */
	public ValoreSensoreService getValoreSensoreService() {
	...
	public String getOSGiServiceIdentifier() {
		return ValoreSensoreService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = valoreSensorePersistence.getDataSource();
	...
	@BeanReference(type = ValoreSensoreService.class)
	protected ValoreSensoreService valoreSensoreService;
