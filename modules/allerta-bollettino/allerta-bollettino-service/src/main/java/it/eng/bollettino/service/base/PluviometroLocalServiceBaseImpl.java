...
public abstract class PluviometroLocalServiceBaseImpl
	...
	implements PluviometroLocalService, IdentifiableOSGiService {
	 ...
	 */
	public PluviometroLocalService getPluviometroLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"it.eng.bollettino.model.Pluviometro", pluviometroLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"it.eng.bollettino.model.Pluviometro");
	}
	...
	@BeanReference(type = PluviometroLocalService.class)
