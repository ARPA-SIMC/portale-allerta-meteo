...
import it.eng.bollettino.service.BollettinoBacinoLocalService;
...
/**
 * Provides the base implementation for the bollettino bacino local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.eng.bollettino.service.impl.BollettinoBacinoLocalServiceImpl}.
 * </p>
 *
 * @author GFAVINI
 * @see it.eng.bollettino.service.impl.BollettinoBacinoLocalServiceImpl
 * @generated
 */
public abstract class BollettinoBacinoLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, BollettinoBacinoLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>BollettinoBacinoLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>it.eng.bollettino.service.BollettinoBacinoLocalServiceUtil</code>.
	 */
	...
	public BollettinoBacino addBollettinoBacino(
		...
		return bollettinoBacinoPersistence.update(bollettinoBacino);
	}
	...
	public BollettinoBacino createBollettinoBacino(long id) {
		return bollettinoBacinoPersistence.create(id);
	}
	...
	public BollettinoBacino deleteBollettinoBacino(long id)
		...
		return bollettinoBacinoPersistence.remove(id);
	}
	...
	public BollettinoBacino deleteBollettinoBacino(
		...
		return bollettinoBacinoPersistence.remove(bollettinoBacino);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return bollettinoBacinoPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			BollettinoBacino.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return bollettinoBacinoPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return bollettinoBacinoPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return bollettinoBacinoPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return bollettinoBacinoPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public BollettinoBacino fetchBollettinoBacino(long id) {
		return bollettinoBacinoPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public BollettinoBacino getBollettinoBacino(long id)
		throws PortalException {

		return bollettinoBacinoPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(BollettinoBacino.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(BollettinoBacino.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return bollettinoBacinoPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement BollettinoBacinoLocalServiceImpl#deleteBollettinoBacino(BollettinoBacino) to avoid orphaned data");
		}

		return bollettinoBacinoLocalService.deleteBollettinoBacino(
			(BollettinoBacino)persistedModel);
	}

	@Override
	public BasePersistence<BollettinoBacino> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return bollettinoBacinoPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<BollettinoBacino> getBollettinoBacinos(int start, int end) {
		return bollettinoBacinoPersistence.findAll(start, end);
	}
	...
	public int getBollettinoBacinosCount() {
		return bollettinoBacinoPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			BollettinoBacinoLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		bollettinoBacinoLocalService = (BollettinoBacinoLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return BollettinoBacinoLocalService.class.getName();
	}
	...
	protected BollettinoBacinoLocalService bollettinoBacinoLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		BollettinoBacinoLocalServiceBaseImpl.class);
