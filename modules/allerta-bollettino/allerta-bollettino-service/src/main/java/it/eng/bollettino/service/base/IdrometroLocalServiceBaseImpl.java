...
public abstract class IdrometroLocalServiceBaseImpl
	...
	implements IdrometroLocalService, IdentifiableOSGiService {
	 ...
	 */
	public IdrometroLocalService getIdrometroLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"it.eng.bollettino.model.Idrometro", idrometroLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"it.eng.bollettino.model.Idrometro");
	}
	...
	@BeanReference(type = IdrometroLocalService.class)
