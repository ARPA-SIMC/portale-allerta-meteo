...
public abstract class AllarmeLocalServiceBaseImpl
	...
	implements AllarmeLocalService, IdentifiableOSGiService {
	 ...
	 */
	public AllarmeLocalService getAllarmeLocalService() {
	...
	public void setAllarmeLocalService(
		AllarmeLocalService allarmeLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"it.eng.bollettino.model.Allarme", allarmeLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"it.eng.bollettino.model.Allarme");
	}
	...
	@BeanReference(type = AllarmeLocalService.class)
