...
public abstract class StazioneVariabileServiceBaseImpl
	...
	implements AopService, IdentifiableOSGiService, StazioneVariabileService {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			StazioneVariabileService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		stazioneVariabileService = (StazioneVariabileService)aopProxy;
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		StazioneVariabileServiceBaseImpl.class);
