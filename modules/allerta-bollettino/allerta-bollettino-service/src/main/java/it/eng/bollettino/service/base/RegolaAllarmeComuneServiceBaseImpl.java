...
public abstract class RegolaAllarmeComuneServiceBaseImpl
	...
	implements AopService, IdentifiableOSGiService, RegolaAllarmeComuneService {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			RegolaAllarmeComuneService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		regolaAllarmeComuneService = (RegolaAllarmeComuneService)aopProxy;
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		RegolaAllarmeComuneServiceBaseImpl.class);
