...
/**
 * Provides the base implementation for the regola allarme local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.eng.bollettino.service.impl.RegolaAllarmeLocalServiceImpl}.
 * </p>
 *
 * @author GFAVINI
 * @see it.eng.bollettino.service.impl.RegolaAllarmeLocalServiceImpl
 * @generated
 */
@ProviderType
public abstract class RegolaAllarmeLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements RegolaAllarmeLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>RegolaAllarmeLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>it.eng.bollettino.service.RegolaAllarmeLocalServiceUtil</code>.
	 */
	...
	public RegolaAllarme addRegolaAllarme(RegolaAllarme regolaAllarme) {
		...
		return regolaAllarmePersistence.update(regolaAllarme);
	}
	...
	public RegolaAllarme createRegolaAllarme(long id) {
		return regolaAllarmePersistence.create(id);
	}
	...
	public RegolaAllarme deleteRegolaAllarme(long id) throws PortalException {
		return regolaAllarmePersistence.remove(id);
	}
	...
	public RegolaAllarme deleteRegolaAllarme(RegolaAllarme regolaAllarme) {
		return regolaAllarmePersistence.remove(regolaAllarme);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			RegolaAllarme.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return regolaAllarmePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return regolaAllarmePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return regolaAllarmePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return regolaAllarmePersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public RegolaAllarme fetchRegolaAllarme(long id) {
		return regolaAllarmePersistence.fetchByPrimaryKey(id);
	}
	...
	public RegolaAllarme getRegolaAllarme(long id) throws PortalException {
		return regolaAllarmePersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(regolaAllarmeLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(RegolaAllarme.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(RegolaAllarme.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return regolaAllarmeLocalService.deleteRegolaAllarme(
			(RegolaAllarme)persistedModel);
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return regolaAllarmePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<RegolaAllarme> getRegolaAllarmes(int start, int end) {
		return regolaAllarmePersistence.findAll(start, end);
	}
	...
	public int getRegolaAllarmesCount() {
		return regolaAllarmePersistence.countAll();
	}
	 ...
	 */
	public RegolaAllarmeLocalService getRegolaAllarmeLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"it.eng.bollettino.model.RegolaAllarme", regolaAllarmeLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"it.eng.bollettino.model.RegolaAllarme");
	}
	...
	public String getOSGiServiceIdentifier() {
		return RegolaAllarmeLocalService.class.getName();
	}
	...
	@BeanReference(type = RegolaAllarmeLocalService.class)
	protected RegolaAllarmeLocalService regolaAllarmeLocalService;
