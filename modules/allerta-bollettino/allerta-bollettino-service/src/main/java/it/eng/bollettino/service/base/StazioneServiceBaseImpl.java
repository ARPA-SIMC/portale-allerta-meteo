...
public abstract class StazioneServiceBaseImpl
	...
	implements AopService, IdentifiableOSGiService, StazioneService {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			StazioneService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		stazioneService = (StazioneService)aopProxy;
	}
