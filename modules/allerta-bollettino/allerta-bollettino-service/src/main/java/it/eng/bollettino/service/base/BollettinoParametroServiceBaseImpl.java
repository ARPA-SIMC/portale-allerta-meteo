...
public abstract class BollettinoParametroServiceBaseImpl
	...
	implements BollettinoParametroService, IdentifiableOSGiService {
	 ...
	 */
	public BollettinoParametroService getBollettinoParametroService() {
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				bollettinoParametroPersistence.getDataSource();
	...
	@BeanReference(type = BollettinoParametroService.class)
