...
@Component(
	property = {
		"class.name=it.eng.bollettino.model.impl.BollettinoImpl",
		"table.name=BOLLETTINO_Bollettino"
	},
...
public class BollettinoModelArgumentsResolver implements ArgumentsResolver {
	...
	static {
		...
		orderByColumnsBitmask |= BollettinoModelImpl.getColumnBitmask("numero");
