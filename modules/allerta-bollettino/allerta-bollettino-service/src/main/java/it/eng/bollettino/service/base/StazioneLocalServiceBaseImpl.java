...
public abstract class StazioneLocalServiceBaseImpl
	...
	implements StazioneLocalService, IdentifiableOSGiService {
	 ...
	 */
	public StazioneLocalService getStazioneLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"it.eng.bollettino.model.Stazione", stazioneLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"it.eng.bollettino.model.Stazione");
	}
	...
	@BeanReference(type = StazioneLocalService.class)
