...
import it.eng.bollettino.service.BollettinoBacinoService;
...
/**
 * Provides the base implementation for the bollettino bacino remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.eng.bollettino.service.impl.BollettinoBacinoServiceImpl}.
 * </p>
 *
 * @author GFAVINI
 * @see it.eng.bollettino.service.impl.BollettinoBacinoServiceImpl
 * @generated
 */
public abstract class BollettinoBacinoServiceBaseImpl
	extends BaseServiceImpl
	implements BollettinoBacinoService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>BollettinoBacinoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>it.eng.bollettino.service.BollettinoBacinoServiceUtil</code>.
	 */
	 ...
	 */
	public BollettinoBacinoService getBollettinoBacinoService() {
	...
	public String getOSGiServiceIdentifier() {
		return BollettinoBacinoService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = bollettinoBacinoPersistence.getDataSource();
	...
	@BeanReference(type = BollettinoBacinoService.class)
	protected BollettinoBacinoService bollettinoBacinoService;
