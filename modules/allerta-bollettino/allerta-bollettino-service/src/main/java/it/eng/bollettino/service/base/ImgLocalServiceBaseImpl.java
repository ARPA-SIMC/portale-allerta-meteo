...
import it.eng.bollettino.service.ImgLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.eng.bollettino.service.impl.ImgLocalServiceImpl}.
 * </p>
 *
 * @author GFAVINI
 * @see it.eng.bollettino.service.impl.ImgLocalServiceImpl
 * @generated
 */
@ProviderType
public abstract class ImgLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ImgLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>it.eng.bollettino.service.ImgLocalServiceUtil</code>.
	 */
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"it.eng.bollettino.model.Img", imgLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"it.eng.bollettino.model.Img");
	}
