...
public abstract class IconaServiceBaseImpl
	...
	implements AopService, IconaService, IdentifiableOSGiService {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			IconaService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		iconaService = (IconaService)aopProxy;
	}
