...
import it.eng.bollettino.service.IconaService;
...
/**
 * Provides the base implementation for the icona remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.eng.bollettino.service.impl.IconaServiceImpl}.
 * </p>
 *
 * @author GFAVINI
 * @see it.eng.bollettino.service.impl.IconaServiceImpl
 * @generated
 */
public abstract class IconaServiceBaseImpl
	extends BaseServiceImpl implements IconaService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>IconaService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>it.eng.bollettino.service.IconaServiceUtil</code>.
	 */
	 ...
	 */
	public IconaService getIconaService() {
		return iconaService;
	}
	 ...
	 */
	public void setIconaService(IconaService iconaService) {
	...
	public String getOSGiServiceIdentifier() {
		return IconaService.class.getName();
	}
	...
	@BeanReference(type = IconaService.class)
