...
public abstract class AllarmeServiceBaseImpl
	...
	implements AllarmeService, AopService, IdentifiableOSGiService {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AllarmeService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		allarmeService = (AllarmeService)aopProxy;
	}
