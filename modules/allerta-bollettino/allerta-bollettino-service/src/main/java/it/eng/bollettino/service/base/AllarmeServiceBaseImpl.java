...
import it.eng.bollettino.service.AllarmeService;
...
/**
 * Provides the base implementation for the allarme remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.eng.bollettino.service.impl.AllarmeServiceImpl}.
 * </p>
 *
 * @author GFAVINI
 * @see it.eng.bollettino.service.impl.AllarmeServiceImpl
 * @generated
 */
public abstract class AllarmeServiceBaseImpl
	extends BaseServiceImpl implements AllarmeService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AllarmeService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>it.eng.bollettino.service.AllarmeServiceUtil</code>.
	 */
	 ...
	 */
	public AllarmeService getAllarmeService() {
	 ...
	 */
	public void setAllarmeService(AllarmeService allarmeService) {
	...
	public String getOSGiServiceIdentifier() {
		return AllarmeService.class.getName();
	}
	...
	@BeanReference(type = AllarmeService.class)
	protected AllarmeService allarmeService;
