...
public abstract class BollettinoSensoreServiceBaseImpl
	...
	implements AopService, BollettinoSensoreService, IdentifiableOSGiService {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			BollettinoSensoreService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		bollettinoSensoreService = (BollettinoSensoreService)aopProxy;
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		BollettinoSensoreServiceBaseImpl.class);
