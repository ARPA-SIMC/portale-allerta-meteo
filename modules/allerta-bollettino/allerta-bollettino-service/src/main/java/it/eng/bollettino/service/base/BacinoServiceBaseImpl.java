...
public abstract class BacinoServiceBaseImpl
	...
	implements AopService, BacinoService, IdentifiableOSGiService {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			BacinoService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		bacinoService = (BacinoService)aopProxy;
	}
