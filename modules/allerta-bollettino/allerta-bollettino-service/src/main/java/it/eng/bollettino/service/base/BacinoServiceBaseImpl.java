...
import it.eng.bollettino.service.BacinoService;
...
/**
 * Provides the base implementation for the bacino remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.eng.bollettino.service.impl.BacinoServiceImpl}.
 * </p>
 *
 * @author GFAVINI
 * @see it.eng.bollettino.service.impl.BacinoServiceImpl
 * @generated
 */
public abstract class BacinoServiceBaseImpl
	extends BaseServiceImpl implements BacinoService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>BacinoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>it.eng.bollettino.service.BacinoServiceUtil</code>.
	 */
	 ...
	 */
	public BacinoService getBacinoService() {
	 ...
	 */
	public void setBacinoService(BacinoService bacinoService) {
	...
	public String getOSGiServiceIdentifier() {
		return BacinoService.class.getName();
	}
	...
	@BeanReference(type = BacinoService.class)
	protected BacinoService bacinoService;
