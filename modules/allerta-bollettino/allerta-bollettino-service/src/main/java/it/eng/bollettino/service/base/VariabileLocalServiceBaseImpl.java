...
public abstract class VariabileLocalServiceBaseImpl
	...
	implements VariabileLocalService, IdentifiableOSGiService {
	 ...
	 */
	public VariabileLocalService getVariabileLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"it.eng.bollettino.model.Variabile", variabileLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"it.eng.bollettino.model.Variabile");
	}
	...
	@BeanReference(type = VariabileLocalService.class)
