...
public abstract class JsonServiceBaseImpl
	...
	implements AopService, IdentifiableOSGiService, JsonService {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			JsonService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		jsonService = (JsonService)aopProxy;
	}
