...
public abstract class Comuni_wsServiceBaseImpl
	...
	implements AopService, Comuni_wsService, IdentifiableOSGiService {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			Comuni_wsService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		comuni_wsService = (Comuni_wsService)aopProxy;
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		Comuni_wsServiceBaseImpl.class);
