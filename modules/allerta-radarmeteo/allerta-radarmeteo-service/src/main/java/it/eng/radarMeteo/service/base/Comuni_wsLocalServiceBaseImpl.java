...
public abstract class Comuni_wsLocalServiceBaseImpl
	...
	implements Comuni_wsLocalService, IdentifiableOSGiService {
	 ...
	 */
	public Comuni_wsLocalService getComuni_wsLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"it.eng.radarMeteo.model.Comuni_ws", comuni_wsLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"it.eng.radarMeteo.model.Comuni_ws");
	}
	...
	@BeanReference(type = Comuni_wsLocalService.class)
