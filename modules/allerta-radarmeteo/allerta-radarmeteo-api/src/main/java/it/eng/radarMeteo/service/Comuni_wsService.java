...
public interface Comuni_wsService extends BaseService {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>it.eng.radarMeteo.service.impl.Comuni_wsServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the comuni_ws remote service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link Comuni_wsServiceUtil} if injection and service tracking are not available.
	 */
	@Transactional
