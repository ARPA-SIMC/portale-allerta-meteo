...
public class Comuni_wsLocalServiceWrapper
	...
	public com.liferay.portal.kernel.model.PersistedModel createPersistedModel(
		...
		return _comuni_wsLocalService.createPersistedModel(primaryKeyObj);
	}
	...
	public <T> T dslQuery(com.liferay.petra.sql.dsl.query.DSLQuery dslQuery) {
		return _comuni_wsLocalService.dslQuery(dslQuery);
	}
	...
	public int dslQueryCount(
		...
		return _comuni_wsLocalService.dslQueryCount(dslQuery);
	}
	...
	public BasePersistence<?> getBasePersistence() {
		return _comuni_wsLocalService.getBasePersistence();
	}
