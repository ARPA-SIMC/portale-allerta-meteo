...
public interface Comuni_wsLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>it.eng.radarMeteo.service.impl.Comuni_wsLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the comuni_ws local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link Comuni_wsLocalServiceUtil} if injection and service tracking are not available.
	 */
