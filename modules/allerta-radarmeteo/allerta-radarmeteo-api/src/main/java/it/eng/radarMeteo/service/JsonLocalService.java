...
public interface JsonLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link JsonLocalServiceUtil} to access the json local service. Add custom service methods to <code>it.eng.radarMeteo.service.impl.JsonLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
