...
/**
 * Provides the local service interface for Json. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Francesco
 * @see JsonLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface JsonLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>it.eng.radarMeteo.service.impl.JsonLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the json local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link JsonLocalServiceUtil} if injection and service tracking are not available.
	 */
