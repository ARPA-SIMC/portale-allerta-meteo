...
public class JsonLocalServiceUtil {
	 ...
	 */
	public static Json addJson(Json json) {
	 ...
	 * @return the new json
	 */
	public static Json createJson(long id) {
	 ...
	 */
	public static Json deleteJson(Json json) {
	 ...
	 */
	public static Json deleteJson(long id) throws PortalException {
	...
	public static Json fetchJson(long id) {
	 ...
	 * @throws PortalException if a json with the primary key could not be found
	 */
	public static Json getJson(long id) throws PortalException {
	 ...
	 */
	public static List<Json> getJsons(int start, int end) {
	 ...
	 */
	public static Json updateJson(Json json) {
	...
	private static final Snapshot<JsonLocalService> _serviceSnapshot =
		new Snapshot<>(JsonLocalServiceUtil.class, JsonLocalService.class);
