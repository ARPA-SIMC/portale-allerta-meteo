...
public class ImgLocalServiceWrapper
	 ...
	 */
	@Override
	public it.eng.radarMeteo.model.Img addImg(it.eng.radarMeteo.model.Img img) {
	 ...
	 */
	@Override
	public it.eng.radarMeteo.model.Img createImg(long id) {
	 ...
	 */
	@Override
	public it.eng.radarMeteo.model.Img deleteImg(
		it.eng.radarMeteo.model.Img img) {
	 ...
	 */
	@Override
	public it.eng.radarMeteo.model.Img deleteImg(long id)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	@Override
	public it.eng.radarMeteo.model.Img fetchImg(long id) {
	 ...
	 */
	@Override
	public it.eng.radarMeteo.model.Img getImg(long id)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public java.util.List<it.eng.radarMeteo.model.Img> getImgs(
		int start, int end) {
	 ...
	 */
	@Override
	public it.eng.radarMeteo.model.Img updateImg(
		it.eng.radarMeteo.model.Img img) {
