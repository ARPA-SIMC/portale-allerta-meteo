 ...
 * <code>it.eng.radarMeteo.service.impl.ImgLocalServiceImpl</code> and
...
public class ImgLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>it.eng.radarMeteo.service.impl.ImgLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static it.eng.radarMeteo.model.Img addImg(
	 ...
	 * @return the new img
	 */
	public static it.eng.radarMeteo.model.Img createImg(long id) {
	 ...
	 */
	public static it.eng.radarMeteo.model.Img deleteImg(
		it.eng.radarMeteo.model.Img img) {
	 ...
	 */
	public static it.eng.radarMeteo.model.Img deleteImg(long id)
	...
	public static it.eng.radarMeteo.model.Img fetchImg(long id) {
	 ...
	 * @throws PortalException if a img with the primary key could not be found
	 */
	public static it.eng.radarMeteo.model.Img getImg(long id)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	public static java.util.List<it.eng.radarMeteo.model.Img> getImgs(
		int start, int end) {
	 ...
	 */
	public static it.eng.radarMeteo.model.Img updateImg(
		it.eng.radarMeteo.model.Img img) {
