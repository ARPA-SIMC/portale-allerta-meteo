...
public class GrigliaValangheManager implements Serializable  {

	private static final long serialVersionUID = -5231431150204567385L;

	List<CellaValangheManager> valori;
	...
	public List<CellaValangheManager> getValori() {
		return valori;
	}

	public void setValori(List<CellaValangheManager> valori) {
		this.valori = valori;
	}
