...
@Component(
	    property = "osgi.http.whiteboard.servlet.pattern=/report/badge",
	    service = Servlet.class
	)
public class BadgeReportServlet extends HttpServlet {
	
	private Log logger = LogFactoryUtil.getLog(BadgeReportServlet.class);
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			String templateName = "badge.jasper";
			
			String filename  = "badge.xls";
