...
public class TipoEventoLocalServiceWrapper
	implements ServiceWrapper<TipoEventoLocalService>, TipoEventoLocalService {
	...
	public com.liferay.portal.kernel.model.PersistedModel createPersistedModel(
		...
		return _tipoEventoLocalService.createPersistedModel(primaryKeyObj);
	}
	...
	public <T> T dslQuery(com.liferay.petra.sql.dsl.query.DSLQuery dslQuery) {
		return _tipoEventoLocalService.dslQuery(dslQuery);
	}
	...
	public int dslQueryCount(
		...
		return _tipoEventoLocalService.dslQueryCount(dslQuery);
	}
	...
	public BasePersistence<?> getBasePersistence() {
		return _tipoEventoLocalService.getBasePersistence();
	}
