...
public interface EmailLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link EmailLocalServiceUtil} to access the email local service. Add custom service methods to <code>it.eng.allerter.service.impl.EmailLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
