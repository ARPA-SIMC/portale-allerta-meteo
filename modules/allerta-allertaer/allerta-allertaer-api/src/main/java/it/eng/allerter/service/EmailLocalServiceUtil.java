...
public class EmailLocalServiceUtil {
	 ...
	 */
	public static Email createEmail(long id) {
	 ...
	 */
	public static Email deleteEmail(long id) throws PortalException {
	...
	public static Email fetchEmail(long id) {
	 ...
	 * @throws PortalException if a email with the primary key could not be found
	 */
	public static Email getEmail(long id) throws PortalException {
