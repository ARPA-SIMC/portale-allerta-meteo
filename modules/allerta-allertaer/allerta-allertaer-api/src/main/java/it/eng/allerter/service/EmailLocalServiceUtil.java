 ...
 * <code>it.eng.allerter.service.impl.EmailLocalServiceImpl</code> and
...
public class EmailLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>it.eng.allerter.service.impl.EmailLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static it.eng.allerter.model.Email addEmail(
	 ...
	 */
	public static it.eng.allerter.model.Email createEmail(long id) {
	 ...
	 */
	public static it.eng.allerter.model.Email deleteEmail(
		it.eng.allerter.model.Email email) {
	 ...
	 */
	public static it.eng.allerter.model.Email deleteEmail(long id)
	...
	public static it.eng.allerter.model.Email fetchEmail(long id) {
	 ...
	 * @throws PortalException if a email with the primary key could not be found
	 */
	public static it.eng.allerter.model.Email getEmail(long id)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	public static java.util.List<it.eng.allerter.model.Email> getEmails(
		int start, int end) {
	 ...
	 */
	public static it.eng.allerter.model.Email updateEmail(
		it.eng.allerter.model.Email email) {
	...
	private static ServiceTracker<EmailLocalService, EmailLocalService>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(EmailLocalService.class);

		ServiceTracker<EmailLocalService, EmailLocalService> serviceTracker =
			new ServiceTracker<EmailLocalService, EmailLocalService>(
				bundle.getBundleContext(), EmailLocalService.class, null);
