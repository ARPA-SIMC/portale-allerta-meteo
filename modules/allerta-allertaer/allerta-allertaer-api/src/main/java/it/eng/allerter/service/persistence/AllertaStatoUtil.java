...
public class AllertaStatoUtil {
	...
	public static List<AllertaStato> findByAllertaId(
		...
		return getPersistence().findByAllertaId(
			allertaId, start, end, orderByComparator, useFinderCache);
	}
	...
	public static void setPersistence(AllertaStatoPersistence persistence) {
		_persistence = persistence;
	}

	private static volatile AllertaStatoPersistence _persistence;
