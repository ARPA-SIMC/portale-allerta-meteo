...
public class StatoAllertamentoLocalServiceWrapper
	implements ServiceWrapper<StatoAllertamentoLocalService>,
	...
	public com.liferay.portal.kernel.model.PersistedModel createPersistedModel(
		...
		return _statoAllertamentoLocalService.createPersistedModel(
			primaryKeyObj);
	}
	...
	public <T> T dslQuery(com.liferay.petra.sql.dsl.query.DSLQuery dslQuery) {
		return _statoAllertamentoLocalService.dslQuery(dslQuery);
	}
	...
	public int dslQueryCount(
		...
		return _statoAllertamentoLocalService.dslQueryCount(dslQuery);
	}
	...
	public BasePersistence<?> getBasePersistence() {
		return _statoAllertamentoLocalService.getBasePersistence();
	}
