...
public class FeedLocalServiceUtil {
	 ...
	 * @return the new feed
	 */
	public static Feed createFeed(String feedId) {
	 ...
	 */
	public static Feed deleteFeed(String feedId) throws PortalException {
	...
	public static Feed fetchFeed(String feedId) {
	 ...
	 * @throws PortalException if a feed with the primary key could not be found
	 */
	public static Feed getFeed(String feedId) throws PortalException {
	...
	private static final Snapshot<FeedLocalService> _serviceSnapshot =
		new Snapshot<>(FeedLocalServiceUtil.class, FeedLocalService.class);
