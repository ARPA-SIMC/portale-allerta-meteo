...
public interface FeedLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link FeedLocalServiceUtil} to access the feed local service. Add custom service methods to <code>it.eng.allerter.service.impl.FeedLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
