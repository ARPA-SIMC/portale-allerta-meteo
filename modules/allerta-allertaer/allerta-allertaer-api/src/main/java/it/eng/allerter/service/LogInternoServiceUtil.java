...
public class LogInternoServiceUtil {
	...
	private static ServiceTracker<LogInternoService, LogInternoService>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(LogInternoService.class);

		ServiceTracker<LogInternoService, LogInternoService> serviceTracker =
			new ServiceTracker<LogInternoService, LogInternoService>(
				bundle.getBundleContext(), LogInternoService.class, null);
