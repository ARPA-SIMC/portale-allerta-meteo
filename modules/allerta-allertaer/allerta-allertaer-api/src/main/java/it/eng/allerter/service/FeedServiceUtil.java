...
public class FeedServiceUtil {
	...
	private static ServiceTracker<FeedService, FeedService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(FeedService.class);

		ServiceTracker<FeedService, FeedService> serviceTracker =
			new ServiceTracker<FeedService, FeedService>(
				bundle.getBundleContext(), FeedService.class, null);
