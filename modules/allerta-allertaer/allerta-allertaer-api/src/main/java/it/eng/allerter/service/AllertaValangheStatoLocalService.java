...
public interface AllertaValangheStatoLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AllertaValangheStatoLocalServiceUtil} to access the allerta valanghe stato local service. Add custom service methods to <code>it.eng.allerter.service.impl.AllertaValangheStatoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
