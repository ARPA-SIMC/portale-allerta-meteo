...
/**
 * Provides the local service interface for AllertaValangheStato. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author GFAVINI
 * @see AllertaValangheStatoLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface AllertaValangheStatoLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>it.eng.allerter.service.impl.AllertaValangheStatoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the allerta valanghe stato local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AllertaValangheStatoLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<AllertaValangheStato> getAllertaValangheStatoByAllertaValanghe(
	...
	public List<AllertaValangheStato>
		getAllertaValangheStatosByUuidAndCompanyId(String uuid, long companyId);
