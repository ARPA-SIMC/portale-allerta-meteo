...
/**
 * Provides the local service interface for AllertaParametro. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author GFAVINI
 * @see AllertaParametroLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface AllertaParametroLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>it.eng.allerter.service.impl.AllertaParametroLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the allerta parametro local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AllertaParametroLocalServiceUtil} if injection and service tracking are not available.
	 */
