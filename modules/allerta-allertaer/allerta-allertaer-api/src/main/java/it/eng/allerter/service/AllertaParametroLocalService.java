...
public interface AllertaParametroLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AllertaParametroLocalServiceUtil} to access the allerta parametro local service. Add custom service methods to <code>it.eng.allerter.service.impl.AllertaParametroLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
