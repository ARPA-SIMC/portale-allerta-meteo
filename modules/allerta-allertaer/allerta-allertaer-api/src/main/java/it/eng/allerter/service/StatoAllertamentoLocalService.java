...
public interface StatoAllertamentoLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link StatoAllertamentoLocalServiceUtil} to access the stato allertamento local service. Add custom service methods to <code>it.eng.allerter.service.impl.StatoAllertamentoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
