...
public interface AreaLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AreaLocalServiceUtil} to access the area local service. Add custom service methods to <code>it.eng.allerter.service.impl.AreaLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
