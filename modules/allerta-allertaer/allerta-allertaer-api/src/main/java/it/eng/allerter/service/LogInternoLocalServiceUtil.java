...
public class LogInternoLocalServiceUtil {
	 ...
	 */
	public static LogInterno addLogInterno(LogInterno logInterno) {
	 ...
	 */
	public static LogInterno createLogInterno(long logId) {
	 ...
	 */
	public static LogInterno deleteLogInterno(LogInterno logInterno) {
	 ...
	 */
	public static LogInterno deleteLogInterno(long logId)
		throws PortalException {
	...
	public static LogInterno fetchLogInterno(long logId) {
	 ...
	 * @throws PortalException if a log interno with the primary key could not be found
	 */
	public static LogInterno getLogInterno(long logId) throws PortalException {
	 ...
	 */
	public static List<LogInterno> getLogInternos(int start, int end) {
	...
	public static List<LogInterno> searchLog(
	 ...
	 */
	public static LogInterno updateLogInterno(LogInterno logInterno) {
	...
	private static final Snapshot<LogInternoLocalService> _serviceSnapshot =
		new Snapshot<>(
			LogInternoLocalServiceUtil.class, LogInternoLocalService.class);
