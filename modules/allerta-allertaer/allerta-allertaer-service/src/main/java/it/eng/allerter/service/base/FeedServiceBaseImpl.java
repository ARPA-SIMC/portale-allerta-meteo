...
public abstract class FeedServiceBaseImpl
	...
	implements AopService, FeedService, IdentifiableOSGiService {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			FeedService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		feedService = (FeedService)aopProxy;
	}
