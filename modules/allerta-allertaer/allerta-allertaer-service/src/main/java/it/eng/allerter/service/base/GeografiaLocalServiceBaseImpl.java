...
public abstract class GeografiaLocalServiceBaseImpl
	...
	implements GeografiaLocalService, IdentifiableOSGiService {
	 ...
	 */
	public GeografiaLocalService getGeografiaLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"it.eng.allerter.model.Geografia", geografiaLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"it.eng.allerter.model.Geografia");
	}
	...
	@BeanReference(type = GeografiaLocalService.class)
