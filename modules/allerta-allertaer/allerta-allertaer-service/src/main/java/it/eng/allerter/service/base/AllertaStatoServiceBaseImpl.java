...
import it.eng.allerter.service.AllertaStatoService;
...
/**
 * Provides the base implementation for the allerta stato remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.eng.allerter.service.impl.AllertaStatoServiceImpl}.
 * </p>
 *
 * @author GFAVINI
 * @see it.eng.allerter.service.impl.AllertaStatoServiceImpl
 * @generated
 */
public abstract class AllertaStatoServiceBaseImpl
	extends BaseServiceImpl
	implements AllertaStatoService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AllertaStatoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>it.eng.allerter.service.AllertaStatoServiceUtil</code>.
	 */
	 ...
	 */
	public AllertaStatoService getAllertaStatoService() {
	...
	public void setAllertaStatoService(
		AllertaStatoService allertaStatoService) {
	...
	public String getOSGiServiceIdentifier() {
		return AllertaStatoService.class.getName();
	}
	...
	@BeanReference(type = AllertaStatoService.class)
	protected AllertaStatoService allertaStatoService;
