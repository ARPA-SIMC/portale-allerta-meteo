...
public abstract class AllertaServiceBaseImpl
	...
	implements AllertaService, AopService, IdentifiableOSGiService {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AllertaService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		allertaService = (AllertaService)aopProxy;
	}
