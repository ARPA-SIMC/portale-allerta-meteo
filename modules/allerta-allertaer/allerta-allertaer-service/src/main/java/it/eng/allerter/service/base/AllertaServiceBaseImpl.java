...
/**
 * Provides the base implementation for the allerta remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.eng.allerter.service.impl.AllertaServiceImpl}.
 * </p>
 *
 * @author GFAVINI
 * @see it.eng.allerter.service.impl.AllertaServiceImpl
 * @generated
 */
public abstract class AllertaServiceBaseImpl
	extends BaseServiceImpl implements AllertaService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AllertaService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>it.eng.allerter.service.AllertaServiceUtil</code>.
	 */
	 ...
	 */
	public AllertaService getAllertaService() {
	 ...
	 */
	public void setAllertaService(AllertaService allertaService) {
	...
	public String getOSGiServiceIdentifier() {
		return AllertaService.class.getName();
	}
	...
	@BeanReference(type = AllertaService.class)
	protected AllertaService allertaService;
