...
/**
 * The implementation of the allerta valanghe local service.
 *
 * <p>
 * All custom service methods should be put in this class. Whenever methods are added, rerun ServiceBuilder to copy their definitions into the <code>it.eng.allerter.service.AllertaValangheLocalService</code> interface.
 *
 * <p>
 ...
 *
 * @author GFAVINI
 * @see AllertaValangheLocalServiceBaseImpl
 */
public class AllertaValangheLocalServiceImpl extends AllertaValangheLocalServiceBaseImpl {
	...
	public DLFolder getDLFolder(String folderName, ServiceContext serviceContext) {		
		...
		try {
			AllertaParametro ap = allertaParametroLocalService.fetchAllertaParametro(AllertaKeys.AllertaValangheParentFolderParamKey);
			if (ap != null)
				parentFolderId = Long.parseLong(ap.getValore());
		} catch (Exception e) {
		}
	...
	public Folder getFolder(long groupId, String folderName) {		
		...
		try {
			AllertaParametro ap = allertaParametroLocalService.fetchAllertaParametro("ALLERTAVALANGHE_PARENT_FOLDER_ID");
			if (ap != null)
				parentFolderId = Long.parseLong(ap.getValore());
		} catch (Exception e) {
		}
