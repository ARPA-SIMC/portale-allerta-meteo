...
public abstract class StatoAllertamentoLocalServiceBaseImpl
	...
	implements StatoAllertamentoLocalService, IdentifiableOSGiService {
	 ...
	 */
	public StatoAllertamentoLocalService getStatoAllertamentoLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"it.eng.allerter.model.StatoAllertamento",
			statoAllertamentoLocalService);
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				statoAllertamentoPersistence.getDataSource();
	...
	@BeanReference(type = StatoAllertamentoLocalService.class)
