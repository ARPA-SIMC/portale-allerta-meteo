...
import it.eng.allerter.service.SMSService;
...
/**
 * Provides the base implementation for the sms remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.eng.allerter.service.impl.SMSServiceImpl}.
 * </p>
 *
 * @author GFAVINI
 * @see it.eng.allerter.service.impl.SMSServiceImpl
 * @generated
 */
public abstract class SMSServiceBaseImpl
	extends BaseServiceImpl implements SMSService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SMSService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>it.eng.allerter.service.SMSServiceUtil</code>.
	 */
	...
	@BeanReference(type = SMSService.class)
