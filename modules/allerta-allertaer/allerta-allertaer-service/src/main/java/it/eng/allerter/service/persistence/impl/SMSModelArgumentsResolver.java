...
/**
 * The arguments resolver class for retrieving value from SMS.
 *
 * @author GFAVINI
 * @generated
 */
@Component(
	property = {
		"class.name=it.eng.allerter.model.impl.SMSImpl",
		"table.name=ALLERTER_SMS"
	},
	service = ArgumentsResolver.class
)
public class SMSModelArgumentsResolver implements ArgumentsResolver {
	...
	public Object[] getArguments(
		...
		if (finderPathColumnBitmask == null) {
			...
			if (finderPath.isBaseModelResult() &&
				(SMSPersistenceImpl.FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION ==
	...
	public String getClassName() {
		return SMSImpl.class.getName();
	}

	@Override
	public String getTableName() {
		return SMSTable.INSTANCE.getTableName();
	}
	...
	private static Object[] _getValue(
		...
		for (int i = 0; i < arguments.length; i++) {
			...
			if (original) {
				arguments[i] = smsModelImpl.getColumnOriginalValue(columnName);
			}
			else {
