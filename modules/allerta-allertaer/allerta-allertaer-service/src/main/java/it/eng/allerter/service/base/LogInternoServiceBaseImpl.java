...
public abstract class LogInternoServiceBaseImpl
	...
	implements AopService, IdentifiableOSGiService, LogInternoService {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			LogInternoService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		logInternoService = (LogInternoService)aopProxy;
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		LogInternoServiceBaseImpl.class);
