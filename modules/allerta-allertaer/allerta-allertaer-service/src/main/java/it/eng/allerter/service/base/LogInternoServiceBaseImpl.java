...
import it.eng.allerter.service.LogInternoService;
...
/**
 * Provides the base implementation for the log interno remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.eng.allerter.service.impl.LogInternoServiceImpl}.
 * </p>
 *
 * @author GFAVINI
 * @see it.eng.allerter.service.impl.LogInternoServiceImpl
 * @generated
 */
public abstract class LogInternoServiceBaseImpl
	extends BaseServiceImpl
	implements LogInternoService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>LogInternoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>it.eng.allerter.service.LogInternoServiceUtil</code>.
	 */
	 ...
	 */
	public LogInternoService getLogInternoService() {
	 ...
	 */
	public void setLogInternoService(LogInternoService logInternoService) {
	...
	public String getOSGiServiceIdentifier() {
		return LogInternoService.class.getName();
	}
	...
	@BeanReference(type = LogInternoService.class)
	protected LogInternoService logInternoService;
