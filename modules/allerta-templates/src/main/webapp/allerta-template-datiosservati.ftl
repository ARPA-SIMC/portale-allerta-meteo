<#if request??><#if (request.getAttribute("LIFERAY_SHARED_THEME_DISPLAY").getLocale()) == 'en_GB'>
<main class="page main page--single-dato" id="main-content">
    ...
    <div class="breadcrumb-container">
        <div class="container d-flex">
            <nav class="row" aria-label="You are in">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                       <a href="/previsioni-e-dati">Forecasts and data</a>
                    </li>
...
<h2>All tools in the Forecasts and Data section</h2>

<ul class="link-list link-list--row row">
	<li class="link-list-item col-12 col-md-3">
	<div class="link-list-span link-list__sub-link-list__heading"><span class="icon i-previsioni-meteo" title="Weather Forecast Icon"></span> Weather forecasts</div>

	<ul class="link-list flex-column">
		<li class="link-list-item"><a class="link-list-link " href="/web/guest/previsioni-regionali" target=""><span class="link-list__item-label">Regional forecasts</span> </a></li>
		<li class="link-list-item"><a class="link-list-link " href="/web/guest/previsioni-a-medio-termine"><span class="link-list__item-label">Midterm forecasts</span> </a></li>
		<li class="link-list-item"><a class="link-list-link " href="/web/guest/previsioni-meteo-modellistiche"><span class="link-list__item-label">Model-based weather forecasts</span> </a></li>
		<li class="link-list-item"><a class="link-list-link " href="/web/guest/previsioni-mare"><span class="link-list__item-label">Sea forecasts</span> </a></li>
	</ul>
	</li>
	<li class="link-list-item col-12 col-md-6">
	<div class="link-list-span link-list__sub-link-list__heading"><span class="icon i-dati-osservati" title="Observational Data Icon"></span>Observational data</div>

	<ul class="link-list link-list--md-two-col">
		<li class="link-list-item"><a class="link-list-link " href="/web/guest/precipitazioni"><span class="link-list__item-label">Precipitations</span> </a></li>
		<li class="link-list-item"><a class="link-list-link " href="/web/guest/livello-idrometrico"><span class="link-list__item-label">Hydrometric levels</span> </a></li>
		<li class="link-list-item"><a class="link-list-link " href="/web/guest/temperature"><span class="link-list__item-label">Temperatures</span> </a></li>
		<li class="link-list-item"><a class="link-list-link " href="/web/guest/vento"><span class="link-list__item-label">Wind</span> </a></li>
		<li class="link-list-item"><a class="link-list-link " href="/web/guest/umidita"><span class="link-list__item-label">Relative humidity</span> </a></li>
		<li class="link-list-item"><a class="link-list-link " href="/web/guest/pressione"><span class="link-list__item-label">Pressure</span> </a></li>
		<li class="link-list-item"><a class="link-list-link " href="/web/guest/livello-mare"><span class="link-list__item-label">Sea level</span> </a></li>
		<li class="link-list-item"><a class="link-list-link " href="/web/guest/altezza-onda"><span class="link-list__item-label">Wave height</span> </a></li>
		<li class="link-list-item"><a class="link-list-link " href="/web/guest/direzione-onda"><span class="link-list__item-label">Wave direction</span> </a></li>
		<li class="link-list-item"><a class="link-list-link " href="/web/guest/cumulativa-6"><span class="link-list__item-label">Cumulative rain 6h</span> </a></li>
		<li class="link-list-item"><a class="link-list-link " href="/web/guest/cumulativa-24"><span class="link-list__item-label">Cumulative rain 24h</span> </a></li>
		<li class="link-list-item"><a class="link-list-link " href="/web/guest/cumulativa-48"><span class="link-list__item-label">Cumulative rain 48h</span> </a></li>
	</ul>
	</li>
	<li class="link-list-item col-12 col-md-3">
	<div class="link-list-span link-list__sub-link-list__heading"><span class="icon i-radar-meteo" title="Weather Radar Icon"></span> Weather radar</div>

	<ul class="link-list flex-column">
		<li class="link-list-item"><a class="link-list-link " href="/web/guest/radar-meteo"><span class="link-list__item-label">Weather radar: rain estimation</span> </a></li>
		<li class="link-list-item"><a class="link-list-link " href="/nowcasting-evoluzione-degli-echi-radar"><span class="link-list__item-label">Nowcasting: evolution of radar echoes</span> </a></li>
	</ul>
	</li>
</ul>
