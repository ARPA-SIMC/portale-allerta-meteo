...
public class StoricoUtil {
	...
	public static List<Storico> findBySigla(
		...
		return getPersistence().findBySigla(
			sigla, start, end, orderByComparator, useFinderCache);
	}
	...
	public static void setPersistence(StoricoPersistence persistence) {
		_persistence = persistence;
	}

	private static volatile StoricoPersistence _persistence;
