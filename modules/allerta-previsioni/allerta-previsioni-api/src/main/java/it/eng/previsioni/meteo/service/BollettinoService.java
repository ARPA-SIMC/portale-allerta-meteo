...
public interface BollettinoService extends BaseService {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link BollettinoServiceUtil} to access the bollettino remote service. Add custom service methods to <code>it.eng.previsioni.meteo.service.impl.BollettinoServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
