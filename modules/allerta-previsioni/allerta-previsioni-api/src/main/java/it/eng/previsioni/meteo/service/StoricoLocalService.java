...
public interface StoricoLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link StoricoLocalServiceUtil} to access the storico local service. Add custom service methods to <code>it.eng.previsioni.meteo.service.impl.StoricoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
