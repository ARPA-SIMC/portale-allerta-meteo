...
public class ImgLocalServiceWrapper
	 ...
	 */
	@Override
	public it.eng.previsioni.meteo.model.Img addImg(
	 ...
	 */
	@Override
	public it.eng.previsioni.meteo.model.Img createImg(long id) {
	...
	public com.liferay.portal.kernel.model.PersistedModel createPersistedModel(
		...
		return _imgLocalService.createPersistedModel(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public it.eng.previsioni.meteo.model.Img deleteImg(
		it.eng.previsioni.meteo.model.Img img) {
	 ...
	 */
	@Override
	public it.eng.previsioni.meteo.model.Img deleteImg(long id)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	public <T> T dslQuery(com.liferay.petra.sql.dsl.query.DSLQuery dslQuery) {
		return _imgLocalService.dslQuery(dslQuery);
	}
	...
	public int dslQueryCount(
		...
		return _imgLocalService.dslQueryCount(dslQuery);
	}
	...
	@Override
	public it.eng.previsioni.meteo.model.Img fetchImg(long id) {
		return _imgLocalService.fetchImg(id);
	}

	@Override
	public java.util.List<it.eng.previsioni.meteo.model.Img> findByDay(
			String day)
		throws com.liferay.portal.kernel.exception.SystemException {

		return _imgLocalService.findByDay(day);
	}
	...
	@Override
	public java.util.List<it.eng.previsioni.meteo.model.Img> getByDayProvincia(
			String day, String provincia)
		throws com.liferay.portal.kernel.exception.SystemException {

		return _imgLocalService.getByDayProvincia(day, provincia);
	}

	@Override
	public it.eng.previsioni.meteo.model.Img getByPartDayProvincia(
			String part, String day, String provincia)
		throws com.liferay.portal.kernel.exception.SystemException,
			   it.eng.previsioni.meteo.exception.NoSuchImgException {

		return _imgLocalService.getByPartDayProvincia(part, day, provincia);
	}
	 ...
	 */
	@Override
	public it.eng.previsioni.meteo.model.Img getImg(long id)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public java.util.List<it.eng.previsioni.meteo.model.Img> getImgs(
		int start, int end) {
	 ...
	 */
	@Override
	public it.eng.previsioni.meteo.model.Img updateImg(
		it.eng.previsioni.meteo.model.Img img) {
	...
	public BasePersistence<?> getBasePersistence() {
		return _imgLocalService.getBasePersistence();
	}
