...
/**
 * Provides the local service interface for Img. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ImgLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ImgLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>it.eng.previsioni.meteo.service.impl.ImgLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the img local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ImgLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Img> getByDayProvincia(String day, String provincia)
		throws SystemException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Img getByPartDayProvincia(String part, String day, String provincia)
		throws NoSuchImgException, SystemException;
