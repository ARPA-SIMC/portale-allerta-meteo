...
public interface ImgService extends BaseService {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>it.eng.previsioni.meteo.service.impl.ImgServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the img remote service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ImgServiceUtil} if injection and service tracking are not available.
	 */
