...
public interface BollettinoLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link BollettinoLocalServiceUtil} to access the bollettino local service. Add custom service methods to <code>it.eng.previsioni.meteo.service.impl.BollettinoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
