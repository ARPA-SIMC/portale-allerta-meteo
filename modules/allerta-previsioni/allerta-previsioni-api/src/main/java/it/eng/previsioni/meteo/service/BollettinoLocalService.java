...
public interface BollettinoLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>it.eng.previsioni.meteo.service.impl.BollettinoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the bollettino local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link BollettinoLocalServiceUtil} if injection and service tracking are not available.
	 */
