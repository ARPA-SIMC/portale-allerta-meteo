...
public class StoricoLocalServiceUtil {
	 ...
	 */
	public static it.eng.previsioni.meteo.model.Storico addStorico(
	 ...
	 */
	public static it.eng.previsioni.meteo.model.Storico createStorico(long id) {
	 ...
	 */
	public static it.eng.previsioni.meteo.model.Storico deleteStorico(long id)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 * @return the storico that was removed
	 */
	public static it.eng.previsioni.meteo.model.Storico deleteStorico(
		it.eng.previsioni.meteo.model.Storico storico) {
	...
	public static it.eng.previsioni.meteo.model.Storico fetchStorico(long id) {
	 ...
	 * @throws PortalException if a storico with the primary key could not be found
	 */
	public static it.eng.previsioni.meteo.model.Storico getStorico(long id)
		throws com.liferay.portal.kernel.exception.PortalException {

		return getService().getStorico(id);
	}

	public static java.util.List<it.eng.previsioni.meteo.model.Storico>
	 ...
	 */
	public static it.eng.previsioni.meteo.model.Storico updateStorico(
		it.eng.previsioni.meteo.model.Storico storico) {
	...
	private static ServiceTracker<StoricoLocalService, StoricoLocalService>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(StoricoLocalService.class);

		ServiceTracker<StoricoLocalService, StoricoLocalService>
			serviceTracker =
				new ServiceTracker<StoricoLocalService, StoricoLocalService>(
					bundle.getBundleContext(), StoricoLocalService.class, null);
