...
public abstract class StoricoLocalServiceBaseImpl
	...
	implements AopService, IdentifiableOSGiService, StoricoLocalService {
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return storicoPersistence.dslQuery(dslQuery);
	}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return storicoPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement StoricoLocalServiceImpl#deleteStorico(Storico) to avoid orphaned data");
		}
	...
	@Override
	public BasePersistence<Storico> getBasePersistence() {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			StoricoLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		storicoLocalService = (StoricoLocalService)aopProxy;
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		StoricoLocalServiceBaseImpl.class);
